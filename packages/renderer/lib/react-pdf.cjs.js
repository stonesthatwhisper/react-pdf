...
var layoutDocument__default = /*#__PURE__*/ _interopDefaultLegacy(
  layoutDocument,
);
var _objectWithoutPropertiesLoose__default = /*#__PURE__*/ _interopDefaultLegacy(
  _objectWithoutPropertiesLoose,
);
var ReactFiberReconciler__default = /*#__PURE__*/ _interopDefaultLegacy(
...
var createRenderer = function createRenderer(_ref) {
  ...
  return ReactFiberReconciler__default['default']({
    ...
    createInstance: function createInstance(type, _ref2) {
      ...
      _ref2.children;
      var props = _objectWithoutPropertiesLoose__default['default'](
        _ref2,
        _excluded,
      );
...
var throwEnvironmentError = function throwEnvironmentError(name) {
  throw new Error(
    name +
      " is a web specific API. You're either using this component on Node, or your bundler is not loading react-pdf from the appropriate web build.",
  );
};
