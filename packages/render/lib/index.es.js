...
var boundingBoxFns =
  ((_boundingBoxFns = {}),
  (_boundingBoxFns[P.Rect] = getRectBoundingBox),
  (_boundingBoxFns[P.Line] = getLineBoundingBox),
  (_boundingBoxFns[P.Path] = getPathBoundingBox),
  (_boundingBoxFns[P.Circle] = getCircleBoundingBox),
  (_boundingBoxFns[P.Ellipse] = getEllipseBoundingBox),
  (_boundingBoxFns[P.Polygon] = getPolylineBoundingBox),
  (_boundingBoxFns[P.Polyline] = getPolylineBoundingBox),
  _boundingBoxFns);
...
var hasLinearGradientFill = function hasLinearGradientFill(node) {
  ...
  return (
    ((_node$props9 = node.props) === null || _node$props9 === void 0
      ...
      ? void 0
      : _node$props9$fill.type) === P.LinearGradient
  );
};
...
var hasRadialGradientFill = function hasRadialGradientFill(node) {
  ...
  return (
    ((_node$props10 = node.props) === null || _node$props10 === void 0
      ...
      ? void 0
      : _node$props10$fill.type) === P.RadialGradient
  );
...
var renderFns$1 =
  ((_renderFns$1 = {}),
  (_renderFns$1[P.Tspan] = noop),
  (_renderFns$1[P.TextInstance] = noop),
  (_renderFns$1[P.Path] = renderPath),
  (_renderFns$1[P.Rect] = renderRect),
  (_renderFns$1[P.Line] = renderLine$1),
  (_renderFns$1[P.G] = renderGroup),
  (_renderFns$1[P.Text] = renderSvgText),
  (_renderFns$1[P.Circle] = renderCircle),
  (_renderFns$1[P.Image] = renderImage$1),
  (_renderFns$1[P.Ellipse] = renderEllipse),
  (_renderFns$1[P.Polygon] = renderPolygon),
  (_renderFns$1[P.Polyline] = renderPolyline),
  _renderFns$1);
...
var renderRun = function renderRun(ctx, run, options) {
  ...
  var opacity = isNil(run.attributes.opacity)
    ? color.opacity
...
var renderFns =
  ((_renderFns = {}),
  (_renderFns[P.Text] = renderText),
  (_renderFns[P.Note] = renderNote),
  (_renderFns[P.Image] = renderImage),
  (_renderFns[P.Canvas] = renderCanvas),
  (_renderFns[P.Svg] = renderSvg),
  (_renderFns[P.Link] = setLink),
  _renderFns);
