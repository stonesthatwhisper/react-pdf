...
import r from 'zlib';
import c from '@babel/runtime/helpers/createForOfIteratorHelperLoose';
import i from 'crypto-js/md5';
import * as n from 'fontkit';
import o from 'fs';
import s from '@react-pdf/png-js';
import u from '@babel/runtime/helpers/extends';
var m = (function(a) {
    function c(e, r, c) {
      var i;
      return (
        ((i =
          ...
          this).finalize = i.finalize.bind(t(i))),
        (i.document = e),
        (i.id = r),
        null == c && (c = {}),
        (i.data = c),
    ...
    return (
      ...
      (i._write = function(e, a, t) {
        return (
          e instanceof Uint8Array || (e = Buffer.from(e + '\n', 'binary')),
      ...
      (i.end = function() {
        return (
          a.prototype.end.apply(this, arguments),
      ...
      (i.finalize = function() {
        if (
          ...
          this.document._write(f.convert(this.data)),
          this.chunks.length)
        ) {
  ...
  l = (function(a) {
    ...
    (function() {
      ...
      return (
        ...
        (a.toString = function() {
          var e = this,
            a = Object.keys(this._items).sort(function(a, t) {
              return e._compareKeys(a, t);
            }),
            t = ['<<'];
          if (this.limits && a.length > 1) {
            var r = a[0],
              i = a[a.length - 1];
            t.push(
              '  /Limits ' +
                f.convert([this._dataForKey(r), this._dataForKey(i)])
            );
          }
          t.push('  /' + this._keysName() + ' [');
          for (var n, o = c(a); !(n = o()).done; ) {
            var s = n.value;
            t.push(
              '    ' +
                f.convert(this._dataForKey(s)) +
                ' ' +
                f.convert(this._items[s])
            );
          }
          return t.push(']'), t.push('>>'), t.join('\n');
        }),
        (a._compareKeys = function() {
          throw new Error('Must be implemented by subclasses');
        }),
        (a._keysName = function() {
          throw new Error('Must be implemented by subclasses');
        }),
        (a._dataForKey = function() {
          throw new Error('Must be implemented by subclasses');
        }),
        e
      );
  ...
  f = (function() {
    ...
    return (
      (e.convert = function(a) {
          ...
          return (
            r &&
              (t = (function(e) {
                ...
                return e;
              })(Buffer.from('\ufeff' + t, 'utf16le')).toString('binary')),
            '(' +
        ...
        if (a instanceof m || a instanceof l) return a.toString();
        if (a instanceof Date)
          return (
            '(D:' +
            g(a.getUTCFullYear(), 4) +
            g(a.getUTCMonth() + 1, 2) +
            g(a.getUTCDate(), 2) +
            g(a.getUTCHours(), 2) +
            g(a.getUTCMinutes(), 2) +
...
var v,
  ...
  C = (function() {
    function e(e, a) {
      void 0 === a && (a = {}),
        ...
        (this.margins = T);
      var t = Array.isArray(this.size) ? this.size : k[this.size.toUpperCase()];
      (this.width = t['portrait' === this.layout ? 0 : 1]),
        (this.height = t['portrait' === this.layout ? 1 : 0]),
  ...
  U = (function() {
    ...
    return (
      (e.generateFileID = function(e) {
        void 0 === e && (e = {});
        var a = e.CreationDate.getTime() + '\n';
        for (var t in e)
          e.hasOwnProperty(t) && (a += t + ': ' + e[t].valueOf() + '\n');
        return (function(e) {
          for (var a = [], t = 0; t < e.sigBytes; t++)
            a.push((e.words[Math.floor(t / 4)] >> (8 * (3 - (t % 4)))) & 255);
  ...
  Y = (function() {
    ...
    return (
      (a.stop = function(e, a, t) {
        ...
        return (
          (t = Math.max(0, Math.min(1, t))), this.stops.push([e, a, t]), this
        );
      }),
      ...
      (a.embed = function(e) {
        ...
        if (0 !== t) {
          ...
          for (var i = [], n = [], o = [], s = 0; s < t - 1; s++)
            n.push(0, 1),
              s + 2 !== t && i.push(this.stops[s + 1][0]),
              (a = this.doc.ref({
                FunctionType: 2,
                Domain: [0, 1],
                C0: this.stops[s + 0][1],
          ...
          if (
            ...
            for (var d, h = c(this.stops); !(d = h()).done; ) {
              var g = d.value;
              l.stop(g[0], [g[2]]);
            }
            l = l.embed(this.matrix);
            var f = [0, 0, this.doc.page.width, this.doc.page.height],
              A = this.doc.ref({
                Type: 'XObject',
                Subtype: 'Form',
                FormType: 1,
            ...
            A.write('/Pattern cs /Sh1 scn'), A.end(f.join(' ') + ' re f');
            var v = this.doc.ref({
              Type: 'ExtGState',
          ...
          } else this.doc.page.patterns[this.id] = m;
          return m;
        }
      }),
      (a.apply = function(e) {
  ...
  w = (function(a) {
    function t(e, t, r, c, i) {
      var n;
      return (
        ((n = a.call(this, e) || this).x1 = t),
        (n.y1 = r),
        (n.x2 = c),
        (n.y2 = i),
        n
  ...
  _ = (function(a) {
    function t(e, t, r, c, i, n, o) {
      var s;
      return (
        ((s = a.call(this, e) || this).doc = e),
        (s.x1 = t),
        (s.y1 = r),
        (s.r1 = c),
        (s.x2 = i),
  ...
  F = { PDFGradient: Y, PDFLinearGradient: w, PDFRadialGradient: _ },
  R = F.PDFGradient,
  D = F.PDFLinearGradient,
  P = F.PDFRadialGradient,
  W = {
    initColor: function() {
      return (
    ...
    _normalizeColor: function(e) {
      ...
      return Array.isArray(e)
        ? (3 === e.length
            ? (e = (function() {
                for (var t = [], r = 0, c = Array.from(e); r < c.length; r++)
                  (a = c[r]), t.push(a / 255);
                return t;
              })())
            : 4 === e.length &&
    ...
    _setColor: function(e, a) {
      ...
      var t = a ? 'SCN' : 'scn';
      if (e instanceof R) this._setColorSpace('Pattern', a), e.apply(t);
      else {
    ...
    linearGradient: function(e, a, t, r) {
      return new D(this, e, a, t, r);
    },
    radialGradient: function(e, a, t, r, c, i) {
      return new P(this, e, a, t, r, c, i);
    }
  },
  B = {
...
var V = {
  ...
  M = {
    M: function(e, a) {
      return (
        (v = a[0]), (p = a[1]), (y = b = null), (x = v), (O = p), e.moveTo(v, p)
      );
    },
    m: function(e, a) {
      return (
    ...
    S: function(e, a) {
      return (
        null === y && ((y = v), (b = p)),
        e.bezierCurveTo(v - (y - v), p - (b - p), a[0], a[1], a[2], a[3]),
        (y = a[0]),
        (b = a[1]),
        (v = a[2]),
        (p = a[3])
    ...
    Q: function(e, a) {
      return (
        ...
        (v = a[2]),
        (p = a[3]),
        e.quadraticCurveTo(a[0], a[1], v, p)
      );
    },
    q: function(e, a) {
      return (
        e.quadraticCurveTo(a[0] + v, a[1] + p, a[2] + v, a[3] + p),
        (y = v + a[0]),
        (b = p + a[1]),
        (v += a[2]),
        (p += a[3])
    ...
    T: function(e, a) {
      return (
        null === y
          ? ((y = v), (b = p))
          : ((y = v - (y - v)), (b = p - (b - p))),
        e.quadraticCurveTo(y, b, a[0], a[1]),
        (y = v - (y - v)),
        (b = p - (b - p)),
        (v = a[0]),
        (p = a[1])
    ...
    t: function(e, a) {
      return (
        null === y
          ? ((y = v), (b = p))
          : ((y = v - (y - v)), (b = p - (b - p))),
        e.quadraticCurveTo(y, b, v + a[0], p + a[1]),
        (v += a[0]),
        (p += a[1])
      );
    },
    A: function(e, a) {
      return E(e, v, p, a), (v = a[5]), (p = a[6]);
    },
    a: function(e, a) {
      return (a[5] += v), (a[6] += p), E(e, v, p, a), (v = a[5]), (p = a[6]);
    },
    L: function(e, a) {
      return (v = a[0]), (p = a[1]), (y = b = null), e.lineTo(v, p);
    },
    l: function(e, a) {
      return (v += a[0]), (p += a[1]), (y = b = null), e.lineTo(v, p);
    },
    H: function(e, a) {
      return (v = a[0]), (y = b = null), e.lineTo(v, p);
    },
    h: function(e, a) {
      return (v += a[0]), (y = b = null), e.lineTo(v, p);
    },
    V: function(e, a) {
      return (p = a[0]), (y = b = null), e.lineTo(v, p);
    },
    v: function(e, a) {
      return (p += a[0]), (y = b = null), e.lineTo(v, p);
    },
    Z: function(e) {
      return e.closePath(), (v = x), (p = O);
    },
    z: function(e) {
      return e.closePath(), (v = x), (p = O);
    }
  ...
  K = function(e, a, t, r, c, i, n, o, s) {
    var u = n * (Math.PI / 180),
      m = Math.sin(u),
      l = Math.cos(u);
    (t = Math.abs(t)), (r = Math.abs(r));
    var d =
      ((y = l * (o - e) * 0.5 + m * (s - a) * 0.5) * y) / (t * t) +
      ((b = l * (s - a) * 0.5 - m * (o - e) * 0.5) * b) / (r * r);
    d > 1 && ((t *= d = Math.sqrt(d)), (r *= d));
    var h = l / t,
      g = m / t,
      f = -m / r,
      A = l / r,
      ...
      x = h * e + g * a,
      O = f * e + A * a,
      T = 1 / ((x - v) * (x - v) + (O - p) * (O - p)) - 0.25;
    T < 0 && (T = 0);
    var k = Math.sqrt(T);
    i === c && (k = -k);
    var C = 0.5 * (v + x) - k * (O - p),
      U = 0.5 * (p + O) + k * (x - v),
      S = Math.atan2(p - U, v - C),
      Y = Math.atan2(O - U, x - C) - S;
    Y < 0 && 1 === i
      ? (Y += 2 * Math.PI)
      : Y > 0 && 0 === i && (Y -= 2 * Math.PI);
    for (
      var w = Math.ceil(Math.abs(Y / (0.5 * Math.PI + 0.001))), _ = [], F = 0;
      F < w;
      F++
    ) {
      var R = S + (F * Y) / w,
          ...
          for (
            ...
            if (!N(s))
              if (i && ',' === s) {
                ...
                (r = []),
                  (i = !1),
                  0 === (c = V[(t = s)]) && a.push({ command: t, args: r });
              } else {
                if (null == t) return a;
                var u = o,
                  m = null;
  ...
  J = {
      ...
      if (Array.isArray(e))
        return (
          (e = Array.from(e)
            ...
            .join(' ')),
          (t = a.phase || 0),
          this.addContent('[' + e + '] ' + f.number(t) + ' d')
        );
      var r = null != a.space ? a.space : e;
      return (
        (t = a.phase || 0),
        this.addContent(
          '[' + f.number(e) + ' ' + f.number(r) + '] ' + f.number(t) + ' d'
        )
      );
    },
    undash: function() {
    ...
    moveTo: function(e, a) {
      return this.addContent(H(e) + ' ' + H(a) + ' m');
    },
    lineTo: function(e, a) {
      return this.addContent(H(e) + ' ' + H(a) + ' l');
    },
    ...
    roundedRect: function(e, a, t, r, c) {
      null == c && (c = 0);
      var i = (c = Math.min(c, 0.5 * t, 0.5 * r)) * (1 - j);
      return (
        this.moveTo(e + c, a),
        this.lineTo(e + t - c, a),
    ...
    rotate: function(e, a) {
      ...
      return this.transform(r, c, -c, r, i, n);
    },
    scale: function(e, a, t) {
      ...
      if (null != t.origin) {
        ...
        (r = i[0]), (c = i[1]), (r -= e * r), (c -= a * c);
      }
      return this.transform(e, 0, 0, a, r, c);
    },
    skew: function(e, a, t) {
      ...
      var r = (e * Math.PI) / 180,
        ...
        s = 0;
      if (null != t.origin) {
        var u = Array.from(t.origin);
        o = u[0];
        var m = (s = u[1]) + n * o;
        (o -= o + i * s), (s -= m);
      }
      return this.transform(1, n, i, 1, o, s);
    }
  },
  X = {
    402: 131,
...
var Z = (function() {
    ...
    (e.open = function(a) {
      return new e(o.readFileSync(a, 'utf8'));
    }),
        ...
        var e = (function(e) {
          for (
            ...
            var n,
              o,
              s = a.value;
            if ((n = s.match(/^Start(\w+)/))) r = n[1];
            else if ((n = s.match(/^End(\w+)/))) r = '';
            else
              switch (r) {
                case 'FontMetrics':
                  var u = (n = s.match(/(^\w+)\s+(.*)/))[1],
                    m = n[2];
                  (o = t.attributes[u])
                    ? (Array.isArray(o) || (o = t.attributes[u] = [o]),
                      o.push(m))
                    : (t.attributes[u] = m);
                  break;
                case 'CharMetrics':
                  if (!/^CH?\s/.test(s)) continue;
                  var l = s.match(/\bN\s+(\.?\w+)\s*;/)[1];
                  t.glyphWidths[l] = +s.match(/\bWX\s+(\d+)\s*;/)[1];
                  break;
                case 'KernPairs':
                  (n = s.match(/^KPX\s+(\.?\w+)\s+(\.?\w+)\s+(-?\d+)/)) &&
                    (t.kernPairs[n[1] + n[2]] = parseInt(n[3]));
              }
          }
          return t;
        })(this.contents);
  ...
  te = (function() {
    ...
    e.open = function(e, a, t, r) {
      var c;
      if ('string' == typeof a) {
        if (re.isStandardFont(a)) return new re(e, a, r);
        c = n.openSync(a, t);
      } else
        a instanceof Uint8Array
          ? (c = n.create(a, t))
          : a instanceof ArrayBuffer
          ? (c = n.create(new Uint8Array(a), t))
          : 'object' == typeof a && (c = a);
      if (null == c)
  ...
  re = (function(a) {
    return (function(a) {
      function t(e, t, r) {
        var c;
        return (
          ((c = a.call(this) || this).document = e),
          (c.name = t),
          (c.id = r),
          (c.font = Z.fromJson(ee[c.name])),
        ...
        (r.encodeGlyphs = function(e) {
          for (var a = [], t = 0; t < e.length; t++) {
            ...
            a.push(('0000' + c.toString(16)).slice(-4)),
              ...
              null == this.unicode[c] &&
                (this.unicode[c] = this.font._cmapProcessor.codePointsForGlyph(
                  r.id
                ));
          }
          return a;
        }),
        (r.widthOfString = function(e, a, t) {
          return this.layout(e, t, !0).advanceWidth * (a / 1e3);
        }),
        (r.embed = function() {
          var e = null != this.subset.cff,
            a = this.document.ref();
          e && (a.data.Subtype = 'CIDFontType0C'), a.end(this.subset.encode());
          var t =
              ((null != this.font['OS/2']
  ...
  oe = {
    ...
    _text: function(e, a, t, r, i) {
      var n = this;
      (e = null == e ? '' : '' + e),
        (r = this._initOptions(a, t, r)).wordSpacing &&
          (e = e.replace(/\s{2,}/g, ' '));
      for (var o, s = c(e.split('\n')); !(o = s()).done; ) {
        var u = o.value;
        r.structParent &&
          r.structParent.add(
            n.struct(r.structType || 'P', [
              n.markStructureContent(r.structType || 'P')
            ])
          ),
          i(u, r);
      }
    ...
    _initOptions: function(e, a, t) {
      ...
      return (
        ...
        !1 !== r.lineBreak &&
          (null == r.width &&
            (r.width = this.page.width - this.x - this.page.margins.right),
    ...
    _glyphs: function(e, a, t, r, c) {
      ...
      this.save(),
        ...
        this.addContent('BT'),
        this.addContent('1 0 0 1 ' + ne(t) + ' ' + ne(r) + ' Tm'),
        this.addContent('/' + this._font.id + ' ' + ne(this._fontSize) + ' Tf');
      ...
      var d = function(t) {
        ...
        h = function(e) {
          if ((d(e), o.length > 0))
            return n.addContent('[' + o.join(' ') + '] TJ'), (o.length = 0);
        };
  ...
  ue = (function() {
    function e(e, a) {
      var t;
      if (
        ((this.data = e), (this.label = a), 65496 !== this.data.readUInt16BE(0))
      )
      ...
      for (
        ...
        (r += 2),
        !Array.from(se).includes(t));

      )
        r += this.data.readUInt16BE(r);
      if (!Array.from(se).includes(t)) throw 'Invalid JPEG.';
      (r += 2),
    ...
    return (
      (a.embed = function(e) {
        ...
        if (((this.document = e), !this.obj)) {
          ...
          if (0 === this.image.palette.length)
            ...
            var n = this.document.ref();
            n.end(Buffer.from(this.image.palette)),
          ...
          if (null != this.image.transparency.grayscale) {
            var o = this.image.transparency.grayscale;
            this.obj.data.Mask = [o, o];
          } else if (this.image.transparency.rgb) {
            for (
              var s, u = this.image.transparency.rgb, m = [], l = c(u);
              !(s = l()).done;
      ...
      (a.splitAlphaChannel = function() {
        ...
        return this.image.decodePixels(function(a) {
          for (
            ...
            for (var d = 0; d < i; d++) (o[c++] = a[u++]), (u += l);
            (s[t++] = a[u++]), (u += l);
          }
          return (
            (e.imgData = r.deflateSync(o)),
            (e.alphaChannel = r.deflateSync(s)),
            e.finalize()
          );
        });
      }),
      (a.loadIndexedAlphaChannel = function() {
        ...
        return this.image.decodePixels(function(t) {
          for (
            var c = Buffer.alloc(e.width * e.height),
              i = 0,
              n = 0,
              o = t.length;
            n < o;
            ...
            c[i++] = a[t[n]];
          return (e.alphaChannel = r.deflateSync(c)), e.finalize();
        });
      }),
      (a.decodeData = function() {
        var e = this;
        this.image.decodePixels(function(a) {
          (e.imgData = r.deflateSync(a)), e.finalize();
        });
      }),
      e
    );
  ...
  le = (function() {
    ...
    return (
      (e.open = function(e, a) {
        var t;
        if (Buffer.isBuffer(e)) t = e;
        else if (e instanceof ArrayBuffer) t = Buffer.from(new Uint8Array(e));
        else {
          var r = /^data:.+;base64,(.*)$/.exec(e);
          if (r) t = Buffer.from(r[1], 'base64');
          else if (!(t = o.readFileSync(e))) return;
        }
        if (255 === t[0] && 216 === t[1]) return new ue(t, a);
  ...
  de = {
    ...
    image: function(e, a, t, r) {
      ...
      var m = e instanceof le ? e : this.embedImage(e);
    ...
    openImage: function(e) {
      ...
      return (
        'string' == typeof e && (a = this._imageRegistry[e]),
        a ||
          ((a = le.open(e, 'I' + ++this._imageCount)),
  ...
  he = {
    annotate: function(e, a, t, r, c) {
      ...
      (c.Border = [0, 0, 0]),
      'Link' === c.Subtype && void 0 === c.F && (c.F = 4),
      'Link' !== c.Subtype &&
        null == c.C &&
    ...
    link: function(e, a, t, r, c, i) {
      if (
        (void 0 === i && (i = {}), (i.Subtype = 'Link'), 'number' == typeof c)
      ) {
        ...
        (i.A = this.ref({
          ...
          i.A.end();
      } else (i.A = this.ref({ S: 'URI', URI: new String(c) })), i.A.end();
  ...
  ge = { top: 0, left: 0, zoom: 0, fit: !1, pageNumber: null, expanded: !1 },
  fe = (function() {
      ...
      (a.endOutline = function() {
        if (this.children.length > 0) {
          ...
          for (var t = 0, r = this.children.length; t < r; t++) {
            ...
            t > 0 && (c.outlineData.Prev = this.children[t - 1].dictionary),
  ...
  Ae = {
    initOutline: function() {
      this.outline = new fe(this, null, null, null);
    },
    endOutline: function() {
  ...
  pe = { left: 0, center: 1, right: 2 },
  ye = { value: 'V', defaultValue: 'DV' },
  be = { zip: '0', zipPlus4: '1', zip4: '1', phone: '2', ssn: '3' },
  xe = {
    nDec: 0,
    sepComma: !1,
    negStyle: 'MinusBlack',
  ...
  Te = {
    ...
    formText: function(e, a, t, r, c, i) {
      return (
        void 0 === i && (i = {}), this.formAnnotation(e, 'text', a, t, r, c, i)
      );
    },
    ...
    formCombo: function(e, a, t, r, c, i) {
      return (
        void 0 === i && (i = {}), this.formAnnotation(e, 'combo', a, t, r, c, i)
      );
    },
    formList: function(e, a, t, r, c, i) {
      return (
        void 0 === i && (i = {}), this.formAnnotation(e, 'list', a, t, r, c, i)
      );
    },
      ...
      if (a && a.type) {
        ...
        if (void 0 !== be[a.type])
          ...
          if (
            ...
            var o = Object.assign({}, Oe, a);
            c = String([String(o.nDec), o.sepComma ? '0' : '1'].join(','));
          }
        }
        (e.AA = e.AA ? e.AA : {}),
          (e.AA.K = { S: 'JavaScript', JS: new String(t + '(' + c + ');') }),
          (e.AA.F = { S: 'JavaScript', JS: new String(r + '(' + c + ');') });
      }
    ...
    _resolveJustify: function(e) {
      ...
      return (
        void 0 !== e.align &&
          ('number' == typeof pe[e.align] && (a = pe[e.align]), delete e.align),
        0 !== a && (e.Q = a),
        e
      );
    },
    _resolveFont: function(e) {
      if (
        ...
        var a = e.fontSize || 0;
        (e.DR.Font[this._font.id] = this._font.ref()),
          (e.DA = new String('/' + this._font.id + ' ' + a + ' Tf 0 g'));
      }
      return e;
    },
    _resolveStrings: function(e) {
      ...
      function t(e) {
        if (Array.isArray(e))
          for (var t = 0; t < e.length; t++)
            'string' == typeof e[t] ? a.push(new String(e[t])) : a.push(e[t]);
      }
      return (
        t(e.Opt),
        ...
        Object.keys(ye).forEach(function(a) {
          void 0 !== e[a] && ((e[ye[a]] = e[a]), delete e[a]);
        }),
  ...
  ke = {
    file: function(e, a) {
      ...
      if (Buffer.isBuffer(e)) t = e;
        ...
        if ((c = /^data:(.*);base64,(.*)$/.exec(e)))
          c[1] && (r.Subtype = c[1].replace('/', '#2F')),
            (t = Buffer.from(c[2], 'base64'));
        else {
          if (!(t = o.readFileSync(e)))
            throw new Error('Could not read contents of file at filepath ' + e);
          var n = o.statSync(e),
            s = n.birthtime,
            m = n.ctime;
          (r.Params.CreationDate = s), (r.Params.ModDate = m);
        }
      }
      a.creationDate instanceof Date &&
        (r.Params.CreationDate = a.creationDate),
        a.modifiedDate instanceof Date && (r.Params.ModDate = a.modifiedDate),
        a.type && (r.Subtype = a.type.replace('/', '#2F'));
      var l,
        d = i.MD5(i.lib.WordArray.create(new Uint8Array(t)));
      (r.Params.CheckSum = new String(d)),
        (r.Params.Size = t.byteLength),
        this._fileRegistry || (this._fileRegistry = {});
      var h = this._fileRegistry[a.name];
      h &&
      (function(e, a) {
        if (
          e.Subtype !== a.Subtype ||
        ...
        ? (l = h.ref)
        : ((l = this.ref(r)).end(t),
          (this._fileRegistry[a.name] = u({}, r, { ref: l })));
      var g = {
        Type: 'Filespec',
        F: new String(a.name),
        EF: { F: l },
      ...
      a.description && (g.Desc = new String(a.description));
      var f = this.ref(g);
      return f.end(), a.hidden || this.addNamedEmbeddedFile(a.name, f), f;
    }
  };
var Ce = function(e) {
  ...
  Ue = (function(a) {
    function t(e) {
      ...
      if (
        ...
        t.options.lang && (t._root.data.Lang = new String(t.options.lang)),
        t.options.pageLayout &&
          (t._root.data.PageLayout = Ce(t.options.pageLayout)),
        t.options.pageMode && (t._root.data.PageMode = Ce(t.options.pageMode)),
        (t.page = null),
        t.initColor(),
        t.initVector(),
        t.initFonts(),
      ...
      return (
        t.options.displayTitle &&
          (t._root.data.ViewerPreferences = t.ref({ DisplayDocTitle: !0 })),
        (t._id = U.generateFileID(t.info)),
    ...
    return (
      ...
      (r._finalize = function() {
        ...
        for (var a = 0, t = Array.from(this._offsets); a < t.length; a++) {
          var r = t[a];
          (r = ('0000000000' + r).slice(-10)), this._write(r + ' 00000 n ');
        }
        var c = {
  ...
  Se = function(e) {
    Object.assign(Ue.prototype, e);
  };
Se(W), Se(J), Se(ie), Se(oe), Se(de), Se(he), Se(Ae), Se(Te), Se(ke);
export { ce as EmbeddedFont, te as PDFFont, re as StandardFont, Ue as default };
