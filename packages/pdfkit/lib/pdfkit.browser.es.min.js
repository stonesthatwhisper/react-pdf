...
import c from 'crypto-js/md5';
import * as s from 'fontkit';
import u from '@react-pdf/png-js';
import l from '@babel/runtime/helpers/extends';
var f =
...
function v(e) {
  ...
  for (
    ...
    o.push(y(e, c, c + a > s ? s : c + a));
  return (
    1 === n
      ? ((t = e[r - 1]), (i += h[t >> 2]), (i += h[(t << 4) & 63]), (i += '=='))
      : 2 === n &&
        ((t = (e[r - 2] << 8) + e[r - 1]),
        (i += h[t >> 10]),
        (i += h[(t >> 4) & 63]),
...
function S(e, t) {
  ...
  return (
    E.TYPED_ARRAY_SUPPORT
      ? ((e = new Uint8Array(t)).__proto__ = E.prototype)
      : (null === e && (e = new E(t)), (e.length = t)),
    e
  );
}
function E(e, t, r) {
  if (!(E.TYPED_ARRAY_SUPPORT || this instanceof E)) return new E(e, t, r);
  if ('number' == typeof e) {
    if ('string' == typeof t)
      throw new Error(
        ...
        if (t) {
          if (
            ...
            return 'number' != typeof t.length || (n = t.length) != n
              ? S(e, 0)
              : R(e, t);
          if ('Buffer' === t.type && _(t.data)) return R(e, t.data);
        }
        var n;
        throw new TypeError(
...
function k(e, t) {
  if ((x(t), (e = S(e, t < 0 ? 0 : 0 | U(t))), !E.TYPED_ARRAY_SUPPORT))
...
function I(e, t, r, n, i) {
  ...
  if (('string' == typeof t && (t = E.from(t, n)), C(t)))
    return 0 === t.length ? -1 : L(e, t, r, n, i);
  if ('number' == typeof t)
    return (
      (t &= 255),
      E.TYPED_ARRAY_SUPPORT && 'function' == typeof Uint8Array.prototype.indexOf
        ? i
...
function N(e, t, r, n) {
  return ae(ie(t, e.length - r), e, r, n);
}
function M(e, t, r, n) {
  return ae(
    (function(e) {
...
function q(e, t, r) {
  return 0 === t && r === e.length ? v(e) : v(e.slice(t, r));
}
function z(e, t, r) {
...
(E.TYPED_ARRAY_SUPPORT =
  void 0 === f.TYPED_ARRAY_SUPPORT || f.TYPED_ARRAY_SUPPORT),
  (E.poolSize = 8192),
  ...
  (E.prototype.compare = function(e, t, r, n, i) {
    if (!C(e)) throw new TypeError('Argument must be a Buffer');
    if (
      (void 0 === t && (t = 0),
...
function ee(e, t, r, n, i) {
  return i || Q(e, 0, r, 4), A(e, t, r, n, 23, 4), r + 4;
}
function te(e, t, r, n, i) {
  return i || Q(e, 0, r, 8), A(e, t, r, n, 52, 8), r + 8;
}
(E.prototype.slice = function(e, t) {
  ...
  if (
    ...
    (r = this.subarray(e, t)).__proto__ = E.prototype;
  else {
    var i = t - e;
    r = new E(i, void 0);
  ...
  (E.prototype.writeFloatLE = function(e, t, r) {
    return ee(this, e, t, !0, r);
  }),
  (E.prototype.writeFloatBE = function(e, t, r) {
    return ee(this, e, t, !1, r);
  }),
  ...
  (E.prototype.copy = function(e, t, r, n) {
    if (
      (r || (r = 0),
      n || 0 === n || (n = this.length),
  ...
  (E.prototype.fill = function(e, t, r, n) {
    if ('string' == typeof e) {
      if (
        ('string' == typeof t
    ...
    if (
      ...
      var a = C(e) ? e : ie(new E(e, n).toString()),
        c = a.length;
...
'function' == typeof f.setTimeout && (me = setTimeout),
  'function' == typeof f.clearTimeout && (ge = clearTimeout);
var ye,
  ve = [],
  be = !1,
  Ae = -1;
function we() {
  be &&
    ye &&
    ((be = !1),
    ye.length ? (ve = ye.concat(ve)) : (Ae = -1),
    ve.length && _e());
}
function _e() {
  if (!be) {
    ...
    for (var t = ve.length; t; ) {
      for (ye = ve, ve = []; ++Ae < t; ) ye && ye[Ae].run();
      (Ae = -1), (t = ve.length);
    }
    (ye = null),
      (be = !1),
      (function(e) {
        if (ge === clearTimeout) return clearTimeout(e);
        if ((ge === de || !ge) && clearTimeout)
          return (ge = clearTimeout), clearTimeout(e);
        try {
          ge(e);
        } catch (t) {
          try {
...
var Ie,
  Le = {
    nextTick: function(e) {
      ...
      ve.push(new Oe(e, t)), 1 !== ve.length || be || pe(_e);
    },
    title: 'browser',
    browser: !0,
    env: {},
  ...
  je = { exports: {} },
  Ne = 'object' == typeof Reflect ? Reflect : null,
  Me =
    Ne && 'function' == typeof Ne.apply
      ? Ne.apply
      : function(e, t, r) {
          return Function.prototype.apply.call(e, t, r);
        };
Ie =
  Ne && 'function' == typeof Ne.ownKeys
    ? Ne.ownKeys
  ...
  (je.exports.once = function(e, t) {
    return new Promise(function(r, n) {
      ...
      Xe(e, t, o, { once: !0 }),
        'error' !== t &&
          (function(e, t, r) {
            'function' == typeof e.on && Xe(e, 'error', t, r);
          })(e, i, { once: !0 });
    });
  }),
  (Ye.EventEmitter = Ye),
...
Object.defineProperty(Ye, 'defaultMaxListeners', {
  ...
  (Ye.prototype.emit = function(e) {
    ...
    if ('function' == typeof c) Me(c, this, t);
    else {
      var s = c.length,
        u = Je(c, s);
      for (r = 0; r < s; ++r) Me(u[r], this, t);
    }
    return !0;
  }),
  ...
  (Ye.prototype.prependListener = function(e, t) {
    return Ve(this, e, t, !0);
  }),
  (Ye.prototype.once = function(e, t) {
    return qe(t), this.on(e, Ke(this, e, t)), this;
  }),
  (Ye.prototype.prependOnceListener = function(e, t) {
    return qe(t), this.prependListener(e, Ke(this, e, t)), this;
  }),
  (Ye.prototype.removeListener = function(e, t) {
    var r, n, i, o, a;
    if ((qe(t), void 0 === (n = this._events))) return this;
...
for (
  var $e = je.exports.EventEmitter,
    ...
    et = {
      ...
      toByteArray: function(e) {
        ...
        for (r = 0; r < s; r += 4)
          (t =
            (rt[e.charCodeAt(r)] << 18) |
            (rt[e.charCodeAt(r + 1)] << 12) |
            (rt[e.charCodeAt(r + 2)] << 6) |
            rt[e.charCodeAt(r + 3)]),
            (a[c++] = (t >> 16) & 255),
            (a[c++] = (t >> 8) & 255),
            (a[c++] = 255 & t);
        2 === o &&
          ((t = (rt[e.charCodeAt(r)] << 2) | (rt[e.charCodeAt(r + 1)] >> 4)),
          (a[c++] = 255 & t));
        1 === o &&
          ((t =
            (rt[e.charCodeAt(r)] << 10) |
            (rt[e.charCodeAt(r + 1)] << 4) |
            (rt[e.charCodeAt(r + 2)] >> 2)),
          (a[c++] = (t >> 8) & 255),
          (a[c++] = 255 & t));
        return a;
      },
      fromByteArray: function(e) {
        for (
          ...
          i.push(st(e, a, a + o > c ? c : a + o));
        1 === n
          ? ((t = e[r - 1]), i.push(tt[t >> 2] + tt[(t << 4) & 63] + '=='))
          : 2 === n &&
            ((t = (e[r - 2] << 8) + e[r - 1]),
            i.push(tt[t >> 10] + tt[(t >> 4) & 63] + tt[(t << 2) & 63] + '='));
        return i.join('');
      }
    },
    tt = [],
  ...
  (tt[ot] = it[ot]), (rt[it.charCodeAt(ot)] = ot);
function ct(e) {
  var t = e.length;
  if (t % 4 > 0)
    throw new Error('Invalid string. Length must be a multiple of 4');
...
var lt = ue(Object.freeze({ __proto__: null, default: {} }));
function ft(e, t) {
  var r = Object.keys(e);
...
var mt = Qe.Buffer,
  gt = lt.inspect,
  pt = (gt && gt.custom) || 'inspect';
function yt(e, t, r) {
  mt.prototype.copy.call(e, t, r);
}
var vt = (function() {
  function e() {
    !(function(e, t) {
  ...
  return (
    ...
    (r = [
      ...
      },
      {
        key: 'concat',
        value: function(e) {
          if (0 === this.length) return mt.alloc(0);
          for (var t = mt.allocUnsafe(e >>> 0), r = this.head, n = 0; r; )
            yt(r.data, t, n), (n += r.data.length), (r = r.next);
          return t;
        }
      },
      {
...
function Et(e, t, r) {
  ...
  (n.prototype.name = r.name), (n.prototype.code = e), (St[e] = n);
}
function Tt(e, t) {
  if (Array.isArray(e)) {
    var r = e.length;
...
Et(
  ...
  (Ot.codes = St);
var xt = Ot.codes.ERR_INVALID_OPT_VALUE;
var kt = {
    getHighWaterMark: function(e, t, r, n) {
      ...
      if (null != i) {
        if (!isFinite(i) || Math.floor(i) !== i || i < 0)
          throw new xt(n ? r : 'highWaterMark', i);
        return Math.floor(i);
      }
...
function Dt(e) {
  ...
  switch (
    ((this.encoding = (function(e) {
      ...
      if ('string' != typeof t && (Pt.isEncoding === Ft || !Ft(e)))
    ...
    case 'utf16le':
      (this.text = jt), (this.end = Nt), (t = 4);
      break;
    case 'utf8':
      (this.fillLast = Lt), (t = 4);
      break;
    case 'base64':
      (this.text = Mt), (this.end = Bt), (t = 3);
      break;
    default:
      return (this.write = Yt), void (this.end = Wt);
  }
  (this.lastNeed = 0),
    (this.lastTotal = 0),
    (this.lastChar = Pt.allocUnsafe(t));
}
function It(e) {
  return e <= 127
    ? 0
...
(Ut.StringDecoder = Dt),
  ...
  (Dt.prototype.end = function(e) {
    var t = e && e.length ? this.write(e) : '';
    return this.lastNeed ? t + '�' : t;
  }),
  (Dt.prototype.text = function(e, t) {
    var r = (function(e, t, r) {
      ...
      if (--n < r || -2 === i) return 0;
      if ((i = It(t[n])) >= 0) return i > 0 && (e.lastNeed = i - 2), i;
      if (--n < r || -2 === i) return 0;
      if ((i = It(t[n])) >= 0)
  ...
  (Dt.prototype.fillLast = function(e) {
...
var qt = Ot.codes.ERR_STREAM_PREMATURE_CLOSE;
function zt() {}
var Vt,
  Gt = function e(t, r, n) {
    ...
    var i = r.readable || (!1 !== r.readable && t.readable),
      ...
      h = function() {
        var e;
        return i && !u
          ? ((t._readableState && t._readableState.ended) || (e = new qt()),
            n.call(t, e))
          : o && !c
          ? ((t._writableState && t._writableState.ended) || (e = new qt()),
            n.call(t, e))
          : void 0;
      },
      d = function() {
...
var Ht = Gt,
  Zt = Symbol('lastResolve'),
  Jt = Symbol('lastReject'),
  Xt = Symbol('error'),
  $t = Symbol('ended'),
  Qt = Symbol('lastPromise'),
  er = Symbol('handlePromise'),
  tr = Symbol('stream');
function rr(e, t) {
...
function nr(e) {
  ...
  if (null !== t) {
    var r = e[tr].read();
    null !== r &&
      ((e[Qt] = null), (e[Zt] = null), (e[Jt] = null), t(rr(r, !1)));
  }
}
function ir(e) {
  Le.nextTick(nr, e);
}
var or = Object.getPrototypeOf(function() {}),
  ar = Object.setPrototypeOf(
    ((Vt = {
      ...
      next: function() {
        ...
        if (this[$t]) return Promise.resolve(rr(void 0, !0));
        if (this[tr].destroyed)
          return new Promise(function(t, r) {
            Le.nextTick(function() {
              e[Xt] ? r(e[Xt]) : t(rr(void 0, !0));
            });
          });
        var r,
          n = this[Qt];
        if (n)
          ...
          var i = this[tr].read();
          if (null !== i) return Promise.resolve(rr(i, !1));
          r = new Promise(this[er]);
        }
        return (this[Qt] = r), r;
      }
    }),
    Kt(Vt, Symbol.asyncIterator, function() {
      return this;
    }),
    Kt(Vt, 'return', function() {
      var e = this;
      return new Promise(function(t, r) {
        e[tr].destroy(null, function(e) {
          e ? r(e) : t(rr(void 0, !0));
        });
      });
    }),
  ...
  cr = function(e) {
    var t,
      r = Object.create(
        ar,
        (Kt((t = {}), tr, { value: e, writable: !0 }),
        Kt(t, Zt, { value: null, writable: !0 }),
        Kt(t, Jt, { value: null, writable: !0 }),
        Kt(t, Xt, { value: null, writable: !0 }),
        Kt(t, $t, { value: e._readableState.endEmitted, writable: !0 }),
        Kt(t, er, {
          value: function(e, t) {
            var n = r[tr].read();
            n
              ? ((r[Qt] = null), (r[Zt] = null), (r[Jt] = null), e(rr(n, !1)))
              : ((r[Zt] = e), (r[Jt] = t));
          },
          writable: !0
        }),
    ...
    return (
      ...
      Ht(e, function(e) {
        if (e && 'ERR_STREAM_PREMATURE_CLOSE' !== e.code) {
          ...
          return (
            null !== t &&
              ((r[Qt] = null), (r[Zt] = null), (r[Jt] = null), t(e)),
            void (r[Xt] = e)
          );
        }
        var n = r[Zt];
        null !== n &&
          ((r[Qt] = null), (r[Zt] = null), (r[Jt] = null), n(rr(void 0, !0))),
          (r[$t] = !0);
      }),
      e.on('readable', ir.bind(null, r)),
      r
    );
  },
  sr = function() {
  ...
  ur = fe;
(ur.Readable = Ur), (Ur.ReadableState = Rr), je.exports.EventEmitter;
var lr = function(e, t) {
    return e.listeners(t).length;
  },
  fr = $e,
  hr = Qe.Buffer,
  dr = se.Uint8Array || function() {};
var mr,
  gr = lt;
mr = gr && gr.debuglog ? gr.debuglog('stream') : function() {};
var pr,
  yr,
  vr,
  br = vt,
  Ar = _t,
  wr = kt.getHighWaterMark,
  _r = Ot.codes,
  Or = _r.ERR_INVALID_ARG_TYPE,
  Sr = _r.ERR_STREAM_PUSH_AFTER_EOF,
  Er = _r.ERR_METHOD_NOT_IMPLEMENTED,
  Tr = _r.ERR_STREAM_UNSHIFT_AFTER_END_EVENT;
Rt.exports(Ur, fr);
var xr = Ar.errorOrDestroy,
  kr = ['error', 'close', 'destroy', 'pause', 'resume'];
function Rr(e, t, r) {
  (e = e || {}),
    'boolean' != typeof r && (r = t instanceof ur.Duplex),
    (this.objectMode = !!e.objectMode),
    r && (this.objectMode = this.objectMode || !!e.readableObjectMode),
    (this.highWaterMark = wr(this, e, 'readableHighWaterMark', r)),
    (this.buffer = new br()),
    (this.length = 0),
    (this.pipes = null),
    (this.pipesCount = 0),
    ...
    (this.encoding = null),
    e.encoding &&
      (pr || (pr = Ut.StringDecoder),
      (this.decoder = new pr(e.encoding)),
      (this.encoding = e.encoding));
}
function Ur(e) {
  if (!(this instanceof Ur)) return new Ur(e);
  var t = this instanceof ur.Duplex;
  (this._readableState = new Rr(e, this, t)),
    (this.readable = !0),
    e &&
...
function Cr(e, t, r, n, i) {
  mr('readableAddChunk', t);
  var o,
    a = e._readableState;
  if (null === t)
    (a.reading = !1),
      (function(e, t) {
        if ((mr('onEofChunk'), t.ended)) return;
        if (t.decoder) {
          var r = t.decoder.end();
          r &&
            r.length &&
        ...
        (t.ended = !0),
          t.sync
            ? Dr(e)
            : ((t.needReadable = !1),
              t.emittedReadable || ((t.emittedReadable = !0), Ir(e)));
      })(e, a);
  else if (
    (i ||
      (o = (function(e, t) {
        ...
        (n = t),
          hr.isBuffer(n) ||
            ...
            void 0 === t ||
            e.objectMode ||
            (r = new Or('chunk', ['string', 'Buffer', 'Uint8Array'], t));
        var n;
        return r;
      })(a, t)),
    o)
    ...
    if (
      ('string' == typeof t ||
        a.objectMode ||
        Object.getPrototypeOf(t) === hr.prototype ||
        (t = (function(e) {
          return hr.from(e);
        })(t)),
      n)
    )
      a.endEmitted ? xr(e, new Tr()) : Pr(e, a, t, !0);
    else if (a.ended) xr(e, new Sr());
    else {
      if (a.destroyed) return !1;
      (a.reading = !1),
        a.decoder && !r
          ? ((t = a.decoder.write(t)),
            a.objectMode || 0 !== t.length ? Pr(e, a, t, !1) : Lr(e, a))
          : Pr(e, a, t, !1);
    }
  else n || ((a.reading = !1), Lr(e, a));
...
Object.defineProperty(Ur.prototype, 'destroyed', {
  ...
  (Ur.prototype.destroy = Ar.destroy),
  (Ur.prototype._undestroy = Ar.undestroy),
...
function Dr(e) {
  ...
  mr('emitReadable', t.needReadable, t.emittedReadable),
    (t.needReadable = !1),
    t.emittedReadable ||
      (mr('emitReadable', t.flowing),
      (t.emittedReadable = !0),
      Le.nextTick(Ir, e));
}
function Ir(e) {
  var t = e._readableState;
  mr('emitReadable_', t.destroyed, t.length, t.ended),
    t.destroyed ||
      (!t.length && !t.ended) ||
...
function Lr(e, t) {
  t.readingMore || ((t.readingMore = !0), Le.nextTick(jr, e, t));
}
function jr(e, t) {
  for (
    ;
    ...
    var r = t.length;
    if ((mr('maybeReadMore read 0'), e.read(0), r === t.length)) break;
  }
  t.readingMore = !1;
}
function Nr(e) {
...
function Mr(e) {
  mr('readable nexttick read 0'), e.read(0);
}
function Br(e, t) {
  mr('resume', t.reading),
    t.reading || e.read(0),
...
function Yr(e) {
  var t = e._readableState;
  for (mr('flow', t.flowing); t.flowing && null !== e.read(); );
}
function Wr(e, t) {
  return 0 === t.length
    ? null
...
function qr(e) {
  var t = e._readableState;
  mr('endReadable', t.endEmitted),
    t.endEmitted || ((t.ended = !0), Le.nextTick(zr, t, e));
}
function zr(e, t) {
  if (
    (mr('endReadableNT', e.endEmitted, e.length),
    !e.endEmitted &&
      0 === e.length &&
...
(Ur.prototype.read = function(e) {
  ...
  if (
    ...
    return (
      mr('read: emitReadable', t.length, t.ended),
      0 === t.length && t.ended ? qr(this) : Dr(this),
      null
    );
  if (0 === (e = Fr(e, t)) && t.ended) return 0 === t.length && qr(this), null;
  var n,
    i = t.needReadable;
  return (
    mr('need readable', i),
    (0 === t.length || t.length - e < t.highWaterMark) &&
      mr('length less than watermark', (i = !0)),
    t.ended || t.reading
      ? mr('reading or ended', (i = !1))
      : i &&
        (mr('do read'),
        (t.reading = !0),
        (t.sync = !0),
  ...
  (Ur.prototype.pipe = function(e, t) {
    ...
    (n.pipesCount += 1), mr('pipe count=%d opts=%j', n.pipesCount, t);
    var i = (!t || !1 !== t.end) && e !== Le.stdout && e !== Le.stderr ? a : d;
    function o(t, i) {
      mr('onunpipe'),
        t === r &&
          i &&
    ...
    n.endEmitted ? Le.nextTick(i) : r.once('end', i), e.on('unpipe', o);
    var c = (function(e) {
      return function() {
        var t = e._readableState;
        mr('pipeOnDrain', t.awaitDrain),
          t.awaitDrain && t.awaitDrain--,
          0 === t.awaitDrain && lr(e, 'data') && ((t.flowing = !0), Yr(e));
      };
    })(r);
    e.on('drain', c);
    var s = !1;
      ...
      mr('dest.write', i),
        !1 === i &&
          (((1 === n.pipesCount && n.pipes === e) ||
            (n.pipesCount > 1 && -1 !== Vr(n.pipes, e))) &&
            !s &&
            (mr('false write response, pause', n.awaitDrain), n.awaitDrain++),
          r.pause());
    }
    function l(t) {
      mr('onerror', t),
    ...
    function h() {
      mr('onfinish'), e.removeListener('close', f), d();
    }
    function d() {
      mr('unpipe'), r.unpipe(e);
    }
    return (
      r.on('data', u),
      (function(e, t, r) {
      ...
      e.once('finish', h),
      e.emit('pipe', r),
      n.flowing || (mr('pipe resume'), r.resume()),
      e
    );
  }),
  ...
  (Ur.prototype.on = function(e, t) {
    var r = fr.prototype.on.call(this, e, t),
      n = this._readableState;
    return (
      'data' === e
        ...
        : 'readable' === e &&
          (n.endEmitted ||
            ...
            (n.flowing = !1),
            (n.emittedReadable = !1),
            mr('on readable', n.length, n.reading),
            n.length ? Dr(this) : n.reading || Le.nextTick(Mr, this))),
      r
    );
  }),
  (Ur.prototype.addListener = Ur.prototype.on),
  (Ur.prototype.removeListener = function(e, t) {
    var r = fr.prototype.removeListener.call(this, e, t);
    return 'readable' === e && Le.nextTick(Nr, this), r;
  }),
  (Ur.prototype.removeAllListeners = function(e) {
    var t = fr.prototype.removeAllListeners.apply(this, arguments);
    return ('readable' !== e && void 0 !== e) || Le.nextTick(Nr, this), t;
  }),
  (Ur.prototype.resume = function() {
    ...
    return (
      e.flowing ||
        ...
        (function(e, t) {
          t.resumeScheduled ||
            ((t.resumeScheduled = !0), Le.nextTick(Br, e, t));
        })(this, e)),
      (e.paused = !1),
      this
    );
  ...
  (Ur.prototype.pause = function() {
    return (
      mr('call pause flowing=%j', this._readableState.flowing),
      !1 !== this._readableState.flowing &&
        (mr('pause'), (this._readableState.flowing = !1), this.emit('pause')),
  ...
  (Ur.prototype.wrap = function(e) {
    ...
    for (var i in (e.on('end', function() {
      if ((mr('wrapped end'), r.decoder && !r.ended)) {
        var e = r.decoder.end();
        e && e.length && t.push(e);
      }
      t.push(null);
    ...
    for (var o = 0; o < kr.length; o++)
      e.on(kr[o], this.emit.bind(this, kr[o]));
    return (
      (this._read = function(t) {
        mr('wrapped _read', t), n && ((n = !1), e.resume());
      }),
      this
    );
  }),
  'function' == typeof Symbol &&
    (Ur.prototype[Symbol.asyncIterator] = function() {
      return void 0 === yr && (yr = cr), yr(this);
    }),
  ...
  'function' == typeof Symbol &&
    (Ur.from = function(e, t) {
      return void 0 === vr && (vr = sr), vr(Ur, e, t);
    });
var Gr = function(e, t) {
  if (Kr('noDeprecation')) return e;
  var r = !1;
  return function() {
    if (!r) {
      if (Kr('throwDeprecation')) throw new Error(t);
      Kr('traceDeprecation') ? console.trace(t) : console.warn(t), (r = !0);
    }
...
(Hr.Writable = pn), (pn.WritableState = gn);
var Jr = { deprecate: Gr },
  Xr = $e,
  $r = Qe.Buffer,
  Qr = se.Uint8Array || function() {};
var en,
  tn = _t,
  rn = kt.getHighWaterMark,
  nn = Ot.codes,
  on = nn.ERR_INVALID_ARG_TYPE,
  an = nn.ERR_METHOD_NOT_IMPLEMENTED,
  cn = nn.ERR_MULTIPLE_CALLBACK,
  sn = nn.ERR_STREAM_CANNOT_PIPE,
  un = nn.ERR_STREAM_DESTROYED,
  ln = nn.ERR_STREAM_NULL_VALUES,
  fn = nn.ERR_STREAM_WRITE_AFTER_END,
  hn = nn.ERR_UNKNOWN_ENCODING,
  dn = tn.errorOrDestroy;
function mn() {}
function gn(e, t, r) {
  (e = e || {}),
    'boolean' != typeof r && (r = t instanceof Hr.Duplex),
    (this.objectMode = !!e.objectMode),
    r && (this.objectMode = this.objectMode || !!e.writableObjectMode),
    (this.highWaterMark = rn(this, e, 'writableHighWaterMark', r)),
    (this.finalCalled = !1),
    (this.needDrain = !1),
    (this.ending = !1),
    (this.ended = !1),
  ...
  (this.decodeStrings = !n),
    ...
    (this.onwrite = function(e) {
      !(function(e, t) {
        var r = e._writableState,
          n = r.sync,
          i = r.writecb;
        if ('function' != typeof i) throw new cn();
        if (
          ((function(e) {
            (e.writing = !1),
              (e.writecb = null),
          ...
          var o = An(r) || e.destroyed;
          o || r.corked || r.bufferProcessing || !r.bufferedRequest || bn(e, r),
            n ? Le.nextTick(vn, e, r, o, i) : vn(e, r, o, i);
        }
      })(t, e);
    }),
    (this.writecb = null),
    ...
    (this.corkedRequestsFree = new Zr(this));
}
function pn(e) {
  var t = this instanceof Hr.Duplex;
  if (!t && !en.call(pn, this)) return new pn(e);
  (this._writableState = new gn(e, this, t)),
    (this.writable = !0),
    e &&
...
function bn(e, t) {
  ...
  if (e._writev && r && r.next) {
    ...
    (i.allBuffers = c),
      yn(e, t, !0, t.length, i, '', o.finish),
      t.pendingcb++,
      (t.lastBufferedRequest = null),
      o.next
        ? ((t.corkedRequestsFree = o.next), (o.next = null))
        : (t.corkedRequestsFree = new Zr(t)),
    ...
    for (; r; ) {
      var s = r.chunk,
        ...
        l = r.callback;
      if (
        (yn(e, t, !1, t.objectMode ? 1 : s.length, s, u, l),
        (r = r.next),
    ...
    ((function(e, t) {
      t.prefinished ||
        ...
        ('function' != typeof e._final || t.destroyed
          ...
          : (t.pendingcb++, (t.finalCalled = !0), Le.nextTick(wn, e, t)));
    })(e, t),
...
Rt.exports(pn, Xr),
  (gn.prototype.getBuffer = function() {
  ...
  'function' == typeof Function.prototype[Symbol.hasInstance]
    ? ((en = Function.prototype[Symbol.hasInstance]),
      Object.defineProperty(pn, Symbol.hasInstance, {
        value: function(e) {
          return (
            !!en.call(this, e) ||
            (this === pn && e && e._writableState instanceof gn)
          );
        }
      }))
    : (en = function(e) {
  ...
  (pn.prototype.write = function(e, t, r) {
    var n,
      i = this._writableState,
      o = !1,
      a = !i.objectMode && ((n = e), $r.isBuffer(n) || n instanceof Qr);
    return (
      a &&
        !$r.isBuffer(e) &&
        (e = (function(e) {
      ...
      i.ending
        ...
        : (a ||
            (function(e, t, r, n) {
              ...
              return (
                null === r
                  ...
                  : 'string' == typeof r ||
                    t.objectMode ||
                    (i = new on('chunk', ['string', 'Buffer'], r)),
                !i || (dn(e, i), Le.nextTick(n, i), !1)
              );
            })(this, i, e, r)) &&
          (i.pendingcb++,
          (o = (function(e, t, r, n, i, o) {
            ...
            } else yn(e, t, !1, c, n, i, o);
            return s;
          })(this, i, a, e, t, r))),
      o
    );
  }),
  (pn.prototype.cork = function() {
    this._writableState.corked++;
  }),
  (pn.prototype.uncork = function() {
  ...
  (pn.prototype.setDefaultEncoding = function(e) {
    if (
  ...
  Object.defineProperty(pn.prototype, 'writableBuffer', {
    enumerable: !1,
    get: function() {
      return this._writableState && this._writableState.getBuffer();
    }
  }),
  Object.defineProperty(pn.prototype, 'writableHighWaterMark', {
    enumerable: !1,
    get: function() {
      return this._writableState.highWaterMark;
    }
  }),
  (pn.prototype._write = function(e, t, r) {
    r(new an('_write()'));
  }),
  (pn.prototype._writev = null),
  (pn.prototype.end = function(e, t, r) {
    ...
    return (
      ...
      n.ending ||
        (function(e, t, r) {
          (t.ending = !0),
            _n(e, t),
            r && (t.finished ? Le.nextTick(r) : e.once('finish', r));
          (t.ended = !0), (e.writable = !1);
        })(this, n, r),
      this
    );
  }),
  Object.defineProperty(pn.prototype, 'writableLength', {
    enumerable: !1,
    get: function() {
      return this._writableState.length;
    }
  }),
  Object.defineProperty(pn.prototype, 'destroyed', {
    enumerable: !1,
    get: function() {
  ...
  (pn.prototype.destroy = tn.destroy),
  (pn.prototype._undestroy = tn.undestroy),
...
var On =
  ...
  Sn = fe;
(Sn.Duplex = kn), Rt.exports(kn, Sn.Readable);
for (var En = On(Sn.Writable.prototype), Tn = 0; Tn < En.length; Tn++) {
  var xn = En[Tn];
  kn.prototype[xn] || (kn.prototype[xn] = Sn.Writable.prototype[xn]);
}
function kn(e) {
  if (!(this instanceof kn)) return new kn(e);
  Sn.Readable.call(this, e),
    Sn.Writable.call(this, e),
    (this.allowHalfOpen = !0),
    e &&
      (!1 === e.readable && (this.readable = !1),
      !1 === e.writable && (this.writable = !1),
      !1 === e.allowHalfOpen &&
        ((this.allowHalfOpen = !1), this.once('end', Rn)));
}
function Rn() {
  this._writableState.ended || Le.nextTick(Un, this);
}
function Un(e) {
  e.end();
}
Object.defineProperty(kn.prototype, 'writableHighWaterMark', {
  enumerable: !1,
  get: function() {
    return this._writableState.highWaterMark;
  }
}),
  Object.defineProperty(kn.prototype, 'writableBuffer', {
    enumerable: !1,
    get: function() {
      return this._writableState && this._writableState.getBuffer();
    }
  }),
  Object.defineProperty(kn.prototype, 'writableLength', {
    enumerable: !1,
    get: function() {
      return this._writableState.length;
    }
  }),
  Object.defineProperty(kn.prototype, 'destroyed', {
    enumerable: !1,
    get: function() {
      return (
...
Cn.Transform = Nn;
var Pn = Ot.codes,
  Fn = Pn.ERR_METHOD_NOT_IMPLEMENTED,
  Dn = Pn.ERR_MULTIPLE_CALLBACK,
  In = Pn.ERR_TRANSFORM_ALREADY_TRANSFORMING,
  Ln = Pn.ERR_TRANSFORM_WITH_LENGTH_0;
function jn(e, t) {
  var r = this._transformState;
  r.transforming = !1;
  var n = r.writecb;
  if (null === n) return this.emit('error', new Dn());
...
function Bn(e, t, r) {
  ...
  if ((null != r && e.push(r), e._writableState.length)) throw new Ln();
  if (e._transformState.transforming) throw new In();
  return e.push(null);
}
Rt.exports(Nn, Cn.Duplex),
  (Nn.prototype.push = function(e, t) {
    return (
      (this._transformState.needTransform = !1),
      Cn.Duplex.prototype.push.call(this, e, t)
    );
  }),
  (Nn.prototype._transform = function(e, t, r) {
    r(new Fn('_transform()'));
  }),
  (Nn.prototype._write = function(e, t, r) {
  ...
  (Nn.prototype._destroy = function(e, t) {
    Cn.Duplex.prototype._destroy.call(this, e, function(e) {
      t(e);
    });
  });
var Yn,
...
(Wn.PassThrough = qn),
  Rt.exports(qn, Wn.Transform),
  (qn.prototype._transform = function(e, t, r) {
    r(null, e);
  });
var zn = Ot.codes,
  Vn = zn.ERR_MISSING_ARGS,
  Gn = zn.ERR_STREAM_DESTROYED;
function Kn(e) {
  if (e) throw e;
}
function Hn(e, t, r, n) {
  ...
  e.on('close', function() {
    ...
    void 0 === Yn && (Yn = Gt),
    Yn(e, { readable: t, writable: r }, function(e) {
      if (e) return n(e);
      (i = !0), n();
    });
  var o = !1;
...
function Xn(e) {
  return e.length ? ('function' != typeof e[e.length - 1] ? Kn : e.pop()) : Kn;
}
var $n = function() {
  ...
  if ((Array.isArray(t[0]) && (t = t[0]), t.length < 2))
    throw new Vn('streams');
  var o = t.map(function(e, r) {
    var a = r < t.length - 1;
    return Hn(e, a, r > 0, function(e) {
      n || (n = e), e && o.forEach(Zn), a || (o.forEach(Zn), i(n));
    });
  });
  return t.reduce(Jn);
};
!(function(e, t) {
  var r = fe;
  ((t = le.exports = r.Readable).Stream = r.Readable),
...
var Qn = le.exports,
  ...
  ci = 'undefined' != typeof Symbol && Symbol,
  si = ai,
  ...
  hi = function(e) {
    var t = this;
    if ('function' != typeof t || '[object Function]' !== fi.call(t))
      throw new TypeError(ui + t);
    for (
      var r,
        n = li.call(arguments, 1),
        i = function() {
          if (this instanceof r) {
            var i = t.apply(this, n.concat(li.call(arguments)));
            return Object(i) === i ? i : this;
          }
          return t.apply(e, n.concat(li.call(arguments)));
        },
  ...
  di = Function.prototype.bind || hi,
  mi = di.call(Function.call, Object.prototype.hasOwnProperty),
  gi = SyntaxError,
  pi = Function,
  yi = TypeError,
  vi = function(e) {
...
var Ai = function() {
  ...
  Si = {},
  Ei = 'undefined' == typeof Uint8Array ? undefined : Oi(Uint8Array),
  Ti = {
    '%AggregateError%':
    ...
    '%ArrayIteratorPrototype%': _i ? Oi([][Symbol.iterator]()) : undefined,
    ...
    '%isFinite%': isFinite,
    '%isNaN%': isNaN,
    '%IteratorPrototype%': _i ? Oi(Oi([][Symbol.iterator]())) : undefined,
    '%JSON%': 'object' == typeof JSON ? JSON : undefined,
    '%Map%': 'undefined' == typeof Map ? undefined : Map,
    '%MapIteratorPrototype%':
      'undefined' != typeof Map && _i
        ? Oi(new Map()[Symbol.iterator]())
        : undefined,
    '%Math%': Math,
    '%Number%': Number,
    '%Object%': Object,
    ...
    '%SetIteratorPrototype%':
      'undefined' != typeof Set && _i
        ? Oi(new Set()[Symbol.iterator]())
        : undefined,
    '%SharedArrayBuffer%':
      'undefined' == typeof SharedArrayBuffer ? undefined : SharedArrayBuffer,
    '%String%': String,
    '%StringIteratorPrototype%': _i ? Oi(''[Symbol.iterator]()) : undefined,
    '%Symbol%': _i ? Symbol : undefined,
    '%SyntaxError%': gi,
    '%ThrowTypeError%': wi,
    '%TypedArray%': Ei,
    '%TypeError%': yi,
  ...
  xi = function e(t) {
    var r;
    if ('%AsyncFunction%' === t) r = vi('async function () {}');
    else if ('%GeneratorFunction%' === t) r = vi('function* () {}');
    else if ('%AsyncGeneratorFunction%' === t) r = vi('async function* () {}');
  ...
  Ri = di,
  Ui = mi,
  Ci = Ri.call(Function.call, Array.prototype.concat),
  Pi = Ri.call(Function.apply, Array.prototype.splice),
  Fi = Ri.call(Function.call, String.prototype.replace),
  Di = Ri.call(Function.call, String.prototype.slice),
  Ii = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
  Li = /\\(\\)?/g,
  ji = function(e) {
    var t = Di(e, 0, 1),
    ...
    var n = [];
    return (
      Fi(e, Ii, function(e, t, r, i) {
        n[n.length] = r ? Fi(i, Li, '$1') : t || e;
      }),
      n
    );
  },
  Ni = function(e, t) {
    var r,
      n = e;
    if ((Ui(ki, n) && (n = '%' + (r = ki[n])[0] + '%'), Ui(Ti, n))) {
      var i = Ti[n];
      if ((i === Si && (i = xi(n)), void 0 === i && !t))
        throw new yi(
          'intrinsic ' +
            e +
    ...
    throw new gi('intrinsic ' + e + ' does not exist!');
  },
  Mi = function(e, t) {
...
var Yi = Mi,
  Wi = Bi.exports,
  qi = Wi(Yi('String.prototype.indexOf')),
  zi = function(e, t) {
    var r = Yi(e, !!t);
    return 'function' == typeof r && qi(e, '.prototype.') > -1 ? Wi(r) : r;
  },
  Vi = 'function' == typeof Symbol && 'symbol' == typeof Symbol.toStringTag,
  Gi = zi('Object.prototype.toString'),
  Ki = function(e) {
    return (
      !(Vi && e && 'object' == typeof e && Symbol.toStringTag in e) &&
      '[object Arguments]' === Gi(e)
    );
  },
  Hi = function(e) {
    return (
      ...
      (null !== e &&
        ...
        e.length >= 0 &&
        '[object Array]' !== Gi(e) &&
        '[object Function]' === Gi(e.callee))
    );
  },
  Zi = (function() {
    return Ki(arguments);
  })();
Ki.isLegacyArguments = Hi;
var Ji,
  Xi = Zi ? Ki : Hi,
  $i = ai,
  Qi = function() {
  ...
  oo = function(e) {
    ...
    if (ro.test(to.call(e))) return !0;
    if (!no) return '[object GeneratorFunction]' === eo.call(e);
    if (!io) return !1;
    if (void 0 === Ji) {
      var t = (function() {
        if (!no) return !1;
  ...
  lo = 'undefined' == typeof globalThis ? se : globalThis,
  fo = function() {
    for (var e = [], t = 0; t < uo.length; t++)
      'function' == typeof lo[uo[t]] && (e[e.length] = uo[t]);
    return e;
  },
  ho = Mi('%Object.getOwnPropertyDescriptor%', !0);
if (ho)
  try {
    ho([], 'length');
  } catch (e) {
...
var mo = ho,
  ...
  po = fo,
  yo = zi,
  vo = yo('Object.prototype.toString'),
  bo = Qi(),
  Ao = 'undefined' == typeof globalThis ? se : globalThis,
  wo = po(),
  _o =
    yo('Array.prototype.indexOf', !0) ||
    function(e, t) {
      for (var r = 0; r < e.length; r += 1) if (e[r] === t) return r;
      return -1;
    },
  Oo = yo('String.prototype.slice'),
  So = {},
  Eo = mo,
...
var xo = function(e) {
  ...
  Ro = fo,
  Uo = zi,
  Co = Uo('Object.prototype.toString'),
  Po = Qi(),
  Fo = 'undefined' == typeof globalThis ? se : globalThis,
  Do = Ro(),
  Io = Uo('String.prototype.slice'),
  Lo = {},
  jo = mo,
...
!(function(e) {
  ...
  (e.format = function(e) {
    ...
    (e.deprecate = function(t, r) {
      if (void 0 !== Le && !0 === Le.noDeprecation) return t;
      if (void 0 === Le)
        return function() {
  ...
  (e.promisify = function(e) {
    ...
    (e.callbackify = function(e) {
      ...
      function r() {
        ...
        e.apply(this, t).then(
          function(e) {
            Le.nextTick(o.bind(null, null, e));
          },
          function(e) {
            Le.nextTick(R.bind(null, e, o));
          }
        );
      }
      return (
...
function Qo(e, t) {
  return !t || ('object' !== aa(t) && 'function' != typeof t) ? ea(e) : t;
}
function ea(e) {
  if (void 0 === e)
    throw new ReferenceError(
...
function ta(e) {
  ...
  return (
    (ta = function(e) {
      ...
      function n() {
        return na(e, arguments, oa(this).constructor);
      }
      return (
...
Zo('ERR_AMBIGUOUS_ARGUMENT', 'The "%s" argument is ambiguous. %s', TypeError),
  Zo(
    'ERR_INVALID_ARG_TYPE',
    function(e, t, r) {
      var n, i, o, a;
      if (
        (void 0 === Go && (Go = ri.exports),
        Go('string' == typeof e, "'name' must be a string"),
        'string' == typeof t &&
        ((i = 'not '), t.substr(!o || o < 0 ? 0 : +o, i.length) === i)
          ? ((n = 'must not be'), (t = t.replace(/^not /, '')))
          : (n = 'must be'),
      ...
      return (a += '. Received type '.concat(Wo(r)));
    },
    TypeError
  ),
  Zo(
  ...
  Zo(
    ...
    function() {
      for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++)
        t[r] = arguments[r];
      void 0 === Go && (Go = ri.exports),
        Go(t.length > 0, 'At least one arg needs to be specified');
      var n = 'The ',
        i = t.length;
      switch (
        ((t = t.map(function(e) {
  ...
  (ni.codes = Ho);
var ca = ii.inspect,
  sa = ni.codes.ERR_INVALID_ARG_TYPE;
function ua(e, t, r) {
  return (
    (void 0 === r || r > e.length) && (r = e.length),
    e.substring(r - t.length, r) === t
...
function da(e, t, r) {
  ...
  for (f = 0; f < p; f++) {
    ...
    if (u.length < f + 1)
      ...
      var _ = l[f],
        O = u[f],
        S = O !== _ && (!ua(O, ',') || O.slice(0, -1) !== _);
      S && ua(_, ',') && _.slice(0, -1) === O && ((S = !1), (O += ',')),
        S
          ? (w > 1 &&
              f > 2 &&
              (w > 4
...
var ma = (function(e) {
    function t(e) {
      ...
      if (((Error.stackTraceLimit = 0), null != n))
        r = Qo(this, oa(t).call(this, String(n)));
      else if (
        ('object' === aa(a) &&
          null !== a &&
          'object' === aa(c) &&
        ...
        r = Qo(this, oa(t).call(this, da(a, c, i)));
        ...
        r =
          1 === l.length
            ? Qo(this, oa(t).call(this, ''.concat(u, ' ').concat(l[0])))
            : Qo(
                this,
                oa(t).call(
                  this,
        ...
        'notDeepEqual' === i || 'notEqual' === i
          ...
          : ((h = ''.concat(ha(c))),
            ...
            'deepEqual' === i || 'equal' === i
              ? (f = ''.concat(d, '\n\n').concat(f, '\n\nshould equal\n\n'))
              : (h = ' '.concat(i, ' ').concat(h))),
          (r = Qo(this, oa(t).call(this, ''.concat(f).concat(h))));
      }
      return (
        (Error.stackTraceLimit = s),
        (r.generatedMessage = !n),
        Object.defineProperty(ea(r), 'name', {
        ...
        (r.expected = c),
        (r.operator = i),
        Error.captureStackTrace && Error.captureStackTrace(ea(r), o),
        r.stack,
    ...
    return (
      r ||
        (r =
          ...
          'number' == typeof e.length &&
          e.length >= 0 &&
          '[object Function]' === ba.call(e.callee)),
      r
    );
  };
if (!Object.keys) {
  var wa = Object.prototype.hasOwnProperty,
    ...
    Ea = !Sa.call({ toString: null }, 'toString'),
    Ta = Sa.call(function() {}, 'prototype'),
    xa = [
      'toString',
      'toLocaleString',
      'valueOf',
  ...
  ya = function(e) {
    var t = null !== e && 'object' == typeof e,
      r = '[object Function]' === _a.call(e),
      n = Oa(e),
      i = t && '[object String]' === _a.call(e),
      o = [];
    if (!t && !r && !n)
      throw new TypeError('Object.keys called on a non-object');
    var a = Ta && r;
    if (i && e.length > 0 && !wa.call(e, 0))
      for (var c = 0; c < e.length; ++c) o.push(String(c));
    if (n && e.length > 0) for (var s = 0; s < e.length; ++s) o.push(String(s));
    else
      for (var u in e)
        (a && 'prototype' === u) || !wa.call(e, u) || o.push(String(u));
    if (Ea)
      for (
        var l = (function(e) {
            if ('undefined' == typeof window || !Ua) return ka(e);
            try {
              return ka(e);
            } catch (e) {
              return !1;
        ...
        (l && 'constructor' === xa[f]) || !wa.call(e, xa[f]) || o.push(xa[f]);
    return o;
  };
}
var Ca = ya,
  ...
  if (Object.keys) {
    ...
    e ||
      (Object.keys = function(e) {
        return Fa(e) ? La(Pa.call(e)) : La(e);
      });
  } else Object.keys = Ia;
  return Object.keys || Ia;
};
var ja = Ia,
  Na = 'function' == typeof Symbol && 'symbol' == typeof Symbol('foo'),
  Ma = Object.prototype.toString,
  Ba = Array.prototype.concat,
  ...
  Wa =
    ...
    (function() {
      var e = {};
      try {
        for (var t in (Ya(e, 'x', { enumerable: !1, value: e }), e)) return !1;
        return e.x === e;
      } catch (e) {
        return !1;
      }
  ...
  qa = function(e, t, r, n) {
    ...
    (!(t in e) ||
      ('function' == typeof (i = n) &&
        '[object Function]' === Ma.call(i) &&
        n())) &&
      (Wa
        ? Ya(e, t, { configurable: !0, enumerable: !1, value: r, writable: !0 })
        : (e[t] = r));
  },
  za = function(e, t) {
    var r = arguments.length > 2 ? arguments[2] : {},
      n = ja(t);
    Na && (n = Ba.call(n, Object.getOwnPropertySymbols(t)));
    for (var i = 0; i < n.length; i += 1) qa(e, n[i], t[n[i]], r[n[i]]);
  };
za.supportsDescriptors = !!Wa;
var Va = za,
  Ga = function(e) {
    return e != e;
  },
  Ka = function(e, t) {
    return 0 === e && 0 === t ? 1 / e == 1 / t : e === t || !(!Ga(e) || !Ga(t));
  },
  Ha = Ka,
  Za = function() {
    return 'function' == typeof Object.is ? Object.is : Ha;
  },
  Ja = Za,
  Xa = Va,
  $a = Va,
  ...
  rc = (0, Bi.exports)(ec(), Object);
$a(rc, { getPolyfill: ec, implementation: Qa, shim: tc });
var nc = rc,
  ic = function(e) {
    return e != e;
  },
  ...
  dc = (0, Bi.exports)(fc(), Number);
uc(dc, { getPolyfill: fc, implementation: lc, shim: hc });
var mc = dc;
function gc(e, t) {
  return (
    (function(e) {
...
var yc = void 0 !== /a/g.flags,
  ...
  Ac = Object.is ? Object.is : nc,
  wc = Object.getOwnPropertySymbols
    ? Object.getOwnPropertySymbols
    : function() {
        return [];
      },
  _c = Number.isNaN ? Number.isNaN : mc;
function Oc(e) {
  return e.call.bind(e);
}
var Sc = Oc(Object.prototype.hasOwnProperty),
  Ec = Oc(Object.prototype.propertyIsEnumerable),
  Tc = Oc(Object.prototype.toString),
  xc = ii.types,
  kc = xc.isAnyArrayBuffer,
  Rc = xc.isArrayBufferView,
  Uc = xc.isDate,
  Cc = xc.isMap,
  Pc = xc.isRegExp,
  Fc = xc.isSet,
  Dc = xc.isNativeError,
  Ic = xc.isBoxedPrimitive,
  Lc = xc.isNumberObject,
  jc = xc.isStringObject,
  Nc = xc.isBooleanObject,
  Mc = xc.isBigIntObject,
  Bc = xc.isSymbolObject,
  Yc = xc.isFloat32Array,
  Wc = xc.isFloat64Array;
function qc(e) {
...
function zc(e) {
  return Object.keys(e)
    .filter(qc)
    .concat(wc(e).filter(Object.prototype.propertyIsEnumerable.bind(e)));
}
/*!
 * The buffer module from node.js, for the browser.
 *
...
function Gc(e, t, r, n) {
  if (e === t) return 0 !== e || !r || Ac(e, t);
  if (r) {
    if ('object' !== pc(e)) return 'number' == typeof e && _c(e) && _c(t);
    if ('object' !== pc(t) || null === e || null === t) return !1;
    if (Object.getPrototypeOf(e) !== Object.getPrototypeOf(t)) return !1;
  } else {
    if (null === e || 'object' !== pc(e))
      return (null === t || 'object' !== pc(t)) && e == t;
    if (null === t || 'object' !== pc(t)) return !1;
  }
  var i,
    o,
    a,
  ...
  if (Array.isArray(e)) {
    ...
    var u = zc(e),
      l = zc(t);
    return u.length === l.length && Hc(e, t, r, n, 1, u);
  }
  if ('[object Object]' === s && ((!Cc(e) && Cc(t)) || (!Fc(e) && Fc(t))))
    return !1;
  if (Uc(e)) {
    if (
      !Uc(t) ||
    ...
    if (
      ...
      return !1;
  } else if (Dc(e) || e instanceof Error) {
    ...
    if (Rc(e)) {
      ...
      var f = zc(e),
        h = zc(t);
      return f.length === h.length && Hc(e, t, r, n, 0, f);
    }
    if (Fc(e)) return !(!Fc(t) || e.size !== t.size) && Hc(e, t, r, n, 2);
    if (Cc(e)) return !(!Cc(t) || e.size !== t.size) && Hc(e, t, r, n, 3);
    if (kc(e)) {
      if (
        ((o = t),
        (i = e).byteLength !== o.byteLength ||
          0 !== Vc(new Uint8Array(i), new Uint8Array(o)))
      )
        return !1;
    } else if (
      Ic(e) &&
...
function Hc(e, t, r, n, i, o) {
  ...
  for (var c = 0; c < o.length; c++) if (!Sc(t, o[c])) return !1;
    ...
    if (0 !== s.length) {
      ...
      for (c = 0; c < s.length; c++) {
        ...
        if (Ec(e, l)) {
          if (!Ec(t, l)) return !1;
          o.push(l), u++;
        } else if (Ec(t, l)) return !1;
      }
      var f = wc(t);
      if (s.length !== f.length && Kc(t, f).length !== u) return !1;
    } else {
      var h = wc(t);
      if (0 !== h.length && 0 !== Kc(t, h).length) return !1;
    }
  }
  if (
    0 === o.length &&
  ...
  var g = es(e, t, r, o, n, i);
  return n.val1.delete(e), n.val2.delete(t), g;
}
function Zc(e, t, r, n) {
  for (var i = vc(e), o = 0; o < i.length; o++) {
    var a = i[o];
    if (Gc(t, a, r, n)) return e.delete(a), !0;
  }
  return !1;
}
function Jc(e) {
...
function $c(e, t, r, n, i) {
  ...
  var a = t.get(o);
  return (
    !((void 0 === a && !t.has(o)) || !Gc(n, a, !1, i)) &&
    !e.has(o) && Gc(n, a, !1, i)
  );
}
function Qc(e, t, r, n, i, o) {
  for (var a = vc(e), c = 0; c < a.length; c++) {
    var s = a[c];
    if (Gc(r, s, i, o) && Gc(n, t.get(s), i, o)) return e.delete(s), !0;
  }
  return !1;
}
function es(e, t, r, n, i, o) {
  ...
  if (2 === o) {
    if (
      !(function(e, t, r, n) {
        for (var i = null, o = vc(e), a = 0; a < o.length; a++) {
          var c = o[a];
          if ('object' === pc(c) && null !== c)
            null === i && (i = new Set()), i.add(c);
          else if (!t.has(c)) {
            if (r) return !1;
            if (!Xc(e, t, c)) return !1;
            null === i && (i = new Set()), i.add(c);
          }
        }
        if (null !== i) {
          for (var s = vc(t), u = 0; u < s.length; u++) {
            var l = s[u];
            if ('object' === pc(l) && null !== l) {
              if (!Zc(i, l, r, n)) return !1;
            } else if (!r && !e.has(l) && !Zc(i, l, r, n)) return !1;
          }
          return 0 === i.size;
        }
        return !0;
    ...
    if (
      !(function(e, t, r, n) {
        for (var i = null, o = bc(e), a = 0; a < o.length; a++) {
          var c = gc(o[a], 2),
            s = c[0],
            u = c[1];
          if ('object' === pc(s) && null !== s)
            null === i && (i = new Set()), i.add(s);
          else {
            var l = t.get(s);
            if ((void 0 === l && !t.has(s)) || !Gc(u, l, r, n)) {
              if (r) return !1;
              if (!$c(e, t, s, u, n)) return !1;
              null === i && (i = new Set()), i.add(s);
            }
          }
        }
        if (null !== i) {
          for (var f = bc(t), h = 0; h < f.length; h++) {
            var d = gc(f[h], 2),
              m = ((s = d[0]), d[1]);
            if ('object' === pc(s) && null !== s) {
              if (!Qc(i, e, s, m, r, n)) return !1;
            } else if (
              !(
                r ||
                (e.has(s) && Gc(e.get(s), m, !1, n)) ||
                Qc(i, e, s, m, !1, n)
              )
            )
              return !1;
    ...
    for (; a < e.length; a++) {
      if (!Sc(e, a)) {
        ...
        for (var c = Object.keys(e); a < c.length; a++) {
          var s = c[a];
          if (!Sc(t, s) || !Gc(e[s], t[s], r, i)) return !1;
        }
        return c.length === Object.keys(t).length;
      }
      if (!Sc(t, a) || !Gc(e[a], t[a], r, i)) return !1;
    }
  for (a = 0; a < n.length; a++) {
    var u = n[a];
    if (!Gc(e[u], t[u], r, i)) return !1;
  }
  return !0;
}
var ts = {
...
var ns,
  is,
  os = ni.codes,
  as = os.ERR_AMBIGUOUS_ARGUMENT,
  cs = os.ERR_INVALID_ARG_TYPE,
  ss = os.ERR_INVALID_ARG_VALUE,
  us = os.ERR_INVALID_RETURN_VALUE,
  ls = os.ERR_MISSING_ARGS,
  fs = ga,
  hs = ii.inspect,
  ds = ii.types,
  ms = ds.isPromise,
  gs = ds.isRegExp,
  ps = Object.assign ? Object.assign : va.assign,
  ys = Object.is ? Object.is : nc;
function vs() {
  (ns = ts.isDeepEqual), (is = ts.isDeepStrictEqual);
}
var bs = !1,
  As = (ri.exports = Ss),
  ws = {};
...
function Ss() {
  for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++)
    t[r] = arguments[r];
  Os.apply(void 0, [Ss, t.length].concat(t));
}
(As.fail = function e(t, r, n, i, o) {
  var a,
    c = arguments.length;
  if (0 === c) a = 'Failed';
  ...
  (As.AssertionError = fs),
  (As.ok = Ss),
  (As.equal = function e(t, r, n) {
    if (arguments.length < 2) throw new ls('actual', 'expected');
    t != r &&
      _s({
        actual: t,
        expected: r,
  ...
  (As.notDeepEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new ls('actual', 'expected');
    void 0 === ns && vs(),
      ns(t, r) &&
        _s({
  ...
  (As.deepStrictEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new ls('actual', 'expected');
    void 0 === ns && vs(),
      is(t, r) ||
        _s({
  ...
  (As.notDeepStrictEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new ls('actual', 'expected');
    void 0 === ns && vs();
    is(t, r) &&
      _s({
  ...
  (As.strictEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new ls('actual', 'expected');
    ys(t, r) ||
      _s({
        actual: t,
  ...
  (As.notStrictEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new ls('actual', 'expected');
    ys(t, r) &&
      _s({
        actual: t,
...
var Es = function e(t, r, n) {
  ...
  !(function(e, t) {
    ...
    r.forEach(function(e) {
      e in t &&
        (void 0 !== n && 'string' == typeof n[e] && gs(t[e]) && t[e].test(n[e])
          ? (i[e] = n[e])
          : (i[e] = t[e]));
    });
};
function Ts(e, t, r, n, i, o) {
  if (!(r in e) || !is(e[r], t[r])) {
    if (!n) {
      var a = new Es(e, i),
        c = new Es(t, i, e),
        s = new fs({
...
function xs(e, t, r, n) {
  if ('function' != typeof t) {
    if (gs(t)) return t.test(e);
    if (2 === arguments.length)
      throw new cs('expected', ['Function', 'RegExp'], t);
    if ('object' !== rs(e) || null === e) {
      var i = new fs({
        actual: e,
        expected: t,
        message: r,
    ...
    if (t instanceof Error) o.push('name', 'message');
      ...
      throw new ss('error', t, 'may not be an empty object');
    return (
      void 0 === ns && vs(),
      o.forEach(function(i) {
        ('string' == typeof e[i] && gs(t[i]) && t[i].test(e[i])) ||
          Ts(e, t, i, r, o, n);
      }),
      !0
    );
...
function ks(e) {
  if ('function' != typeof e) throw new cs('fn', 'Function', e);
  try {
    e();
  } catch (e) {
    return e;
...
function Us(e) {
  return Promise.resolve().then(function() {
    var t;
    if ('function' == typeof e) {
      if (!Rs((t = e()))) throw new us('instance of Promise', 'promiseFn', t);
    } else {
      if (!Rs(e)) throw new cs('promiseFn', ['Function', 'Promise'], e);
      t = e;
    }
...
function Cs(e, t, r, n) {
  if ('string' == typeof r) {
    if (4 === arguments.length)
      throw new cs('error', ['Object', 'Error', 'Function', 'RegExp'], r);
    if ('object' === rs(t) && null !== t) {
      if (t.message === r)
        throw new as(
          'error/message',
    ...
    (n = r), (r = void 0);
  } else if (null != r && 'object' !== rs(r) && 'function' != typeof r)
    throw new cs('error', ['Object', 'Error', 'Function', 'RegExp'], r);
  if (t === ws) {
    var i = '';
  ...
  if (r && !xs(t, r, n, e)) throw t;
}
function Ps(e, t, r, n) {
  if (t !== ws) {
    if (('string' == typeof r && ((n = r), (r = void 0)), !r || xs(t, r))) {
      var i = n ? ': '.concat(n) : '.',
...
function Fs() {
  for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++)
    t[r] = arguments[r];
  Os.apply(void 0, [Fs, t.length].concat(t));
}
(As.throws = function e(t) {
  for (
    ...
    n[i - 1] = arguments[i];
  Cs.apply(void 0, [e, ks(t)].concat(n));
}),
  (As.rejects = function e(t) {
    for (
      var r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), i = 1;
      i < r;
      i++
      ...
      n[i - 1] = arguments[i];
    return Us(t).then(function(t) {
      return Cs.apply(void 0, [e, t].concat(n));
    });
  }),
  (As.doesNotThrow = function e(t) {
    for (
      var r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), i = 1;
      i < r;
      i++
      ...
      n[i - 1] = arguments[i];
    Ps.apply(void 0, [e, ks(t)].concat(n));
  }),
  (As.doesNotReject = function e(t) {
    for (
      var r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), i = 1;
      i < r;
      i++
      ...
      n[i - 1] = arguments[i];
    return Us(t).then(function(t) {
      return Ps.apply(void 0, [e, t].concat(n));
    });
  }),
  (As.ifError = function e(t) {
    if (null != t) {
      var r = 'ifError got unwanted exception: ';
      'object' === rs(t) && 'string' == typeof t.message
  ...
  (As.strict = ps(Fs, As, {
    equal: As.strictEqual,
    deepEqual: As.deepStrictEqual,
    notEqual: As.notStrictEqual,
    notDeepEqual: As.notDeepStrictEqual
  })),
  (As.strict.strict = As.strict),
  (function(e) {
    var t = ri.exports,
      a = r,
      c = n,
  ...
  (function(e) {
    ...
    function T(e, t) {
      t && Le.nextTick(t), e._handle && (e._handle.close(), (e._handle = null));
    }
    function x(e) {
      e.emit('close');
    }
    ...
    return (
      ...
      (i.finalize = function() {
        if (
          ...
          this.document._write(Bs.convert(this.data)),
          this.chunks.length)
        ) {
      ...
      return (
        ...
        (t.toString = function() {
          ...
          if (this.limits && t.length > 1) {
            ...
            r.push(
              '  /Limits ' +
                Bs.convert([this._dataForKey(n), this._dataForKey(i)])
            );
          }
          ...
          for (var o, c = a(t); !(o = c()).done; ) {
            ...
            r.push(
              '    ' +
                Bs.convert(this._dataForKey(s)) +
                ' ' +
                Bs.convert(this._items[s])
            );
          }
          ...
          return (
            n &&
              (r = (function(e) {
                ...
                return e;
              })(E.from('\ufeff' + r, 'utf16le')).toString('binary')),
            '(' +
              (r = r.replace(Ls, function(e) {
                return js[e];
              })) +
              ')'
          );
        }
        if (E.isBuffer(t)) return '<' + t.toString('hex') + '>';
        if (t instanceof Ds || t instanceof Is) return t.toString();
        if (t instanceof Date)
          return (
            '(D:' +
            Ns(t.getUTCFullYear(), 4) +
            Ns(t.getUTCMonth() + 1, 2) +
            Ns(t.getUTCDate(), 2) +
            Ns(t.getUTCHours(), 2) +
            Ns(t.getUTCMinutes(), 2) +
            Ns(t.getUTCSeconds(), 2) +
            'Z)'
          );
        if (Array.isArray(t))
          return (
...
var Ws,
  ...
  Gs,
  Ks,
  Hs = { top: 0, left: 0, bottom: 0, right: 0 },
  Zs = {
    '4A0': [4767.87, 6740.79],
    '2A0': [3370.39, 4767.87],
    A0: [2383.94, 3370.39],
  ...
  ru = { PDFGradient: Qs, PDFLinearGradient: eu, PDFRadialGradient: tu },
  nu = ru.PDFGradient,
  iu = ru.PDFLinearGradient,
  ou = ru.PDFRadialGradient,
  au = {
    initColor: function() {
      return (
    ...
    _setColor: function(e, t) {
      ...
      var r = t ? 'SCN' : 'scn';
      if (e instanceof nu) this._setColorSpace('Pattern', t), e.apply(r);
      else {
    ...
    linearGradient: function(e, t, r, n) {
      return new iu(this, e, t, r, n);
    },
    radialGradient: function(e, t, r, n, i, o) {
      return new ou(this, e, t, r, n, i, o);
    }
  },
  cu = {
...
var su = {
  ...
  du = {
    ...
    S: function(e, t) {
      return (
        null === zs && ((zs = Ws), (Vs = qs)),
        e.bezierCurveTo(Ws - (zs - Ws), qs - (Vs - qs), t[0], t[1], t[2], t[3]),
        (zs = t[0]),
        (Vs = t[1]),
        (Ws = t[2]),
        (qs = t[3])
    ...
    Q: function(e, t) {
      return (
        ...
        (Ws = t[2]),
        (qs = t[3]),
        e.quadraticCurveTo(t[0], t[1], Ws, qs)
      );
    },
    q: function(e, t) {
      return (
        e.quadraticCurveTo(t[0] + Ws, t[1] + qs, t[2] + Ws, t[3] + qs),
        (zs = Ws + t[0]),
        (Vs = qs + t[1]),
        (Ws += t[2]),
        (qs += t[3])
    ...
    T: function(e, t) {
      return (
        null === zs
          ? ((zs = Ws), (Vs = qs))
          : ((zs = Ws - (zs - Ws)), (Vs = qs - (Vs - qs))),
        e.quadraticCurveTo(zs, Vs, t[0], t[1]),
        (zs = Ws - (zs - Ws)),
        (Vs = qs - (Vs - qs)),
        (Ws = t[0]),
        (qs = t[1])
    ...
    t: function(e, t) {
      return (
        null === zs
          ? ((zs = Ws), (Vs = qs))
          : ((zs = Ws - (zs - Ws)), (Vs = qs - (Vs - qs))),
        e.quadraticCurveTo(zs, Vs, Ws + t[0], qs + t[1]),
        (Ws += t[0]),
        (qs += t[1])
      );
    },
    A: function(e, t) {
      return mu(e, Ws, qs, t), (Ws = t[5]), (qs = t[6]);
    },
    a: function(e, t) {
      return (
        (t[5] += Ws), (t[6] += qs), mu(e, Ws, qs, t), (Ws = t[5]), (qs = t[6])
      );
    },
    L: function(e, t) {
      return (Ws = t[0]), (qs = t[1]), (zs = Vs = null), e.lineTo(Ws, qs);
    },
    l: function(e, t) {
      return (Ws += t[0]), (qs += t[1]), (zs = Vs = null), e.lineTo(Ws, qs);
    },
    H: function(e, t) {
      return (Ws = t[0]), (zs = Vs = null), e.lineTo(Ws, qs);
    },
    h: function(e, t) {
      return (Ws += t[0]), (zs = Vs = null), e.lineTo(Ws, qs);
    },
    V: function(e, t) {
      return (qs = t[0]), (zs = Vs = null), e.lineTo(Ws, qs);
    },
    v: function(e, t) {
      return (qs += t[0]), (zs = Vs = null), e.lineTo(Ws, qs);
    },
    Z: function(e) {
      return e.closePath(), (Ws = Gs), (qs = Ks);
    },
    z: function(e) {
      return e.closePath(), (Ws = Gs), (qs = Ks);
    }
  ...
  gu = function(e, t, r, n, i, o, a, c, s) {
    var u = a * (Math.PI / 180),
      l = Math.sin(u),
      f = Math.cos(u);
    (r = Math.abs(r)), (n = Math.abs(n));
    var h =
      ((zs = f * (c - e) * 0.5 + l * (s - t) * 0.5) * zs) / (r * r) +
      ((Vs = f * (s - t) * 0.5 - l * (c - e) * 0.5) * Vs) / (n * n);
          ...
          for (
            ...
            if (!lu(s))
              if (o && ',' === s) {
                ...
                (n = []),
                  (o = !1),
                  0 === (i = su[(r = s)]) && t.push({ command: r, args: n });
              } else {
                if (null == r) return t;
                var u = c,
                  l = null;
  ...
  Au = {
      ...
      if (Array.isArray(e))
        return (
          (e = Array.from(e)
            ...
            .join(' ')),
          (r = t.phase || 0),
          this.addContent('[' + e + '] ' + Bs.number(r) + ' d')
        );
      var n = null != t.space ? t.space : e;
      return (
        (r = t.phase || 0),
        this.addContent(
          '[' + Bs.number(e) + ' ' + Bs.number(n) + '] ' + Bs.number(r) + ' d'
        )
      );
    },
    undash: function() {
    ...
    roundedRect: function(e, t, r, n, i) {
      null == i && (i = 0);
      var o = (i = Math.min(i, 0.5 * r, 0.5 * n)) * (1 - bu);
      return (
        this.moveTo(e + i, t),
        this.lineTo(e + r - i, t),
...
var Ou = (function() {
  ...
  xu = (function() {
    ...
    e.open = function(e, t, r, n) {
      var i;
      if ('string' == typeof t) {
        if (ku.isStandardFont(t)) return new ku(e, t, n);
  ...
  Pu = {
    ...
    _glyphs: function(e, t, r, n, i) {
      ...
      this.save(),
        ...
        this.addContent('BT'),
        this.addContent('1 0 0 1 ' + Cu(r) + ' ' + Cu(n) + ' Tm'),
        this.addContent('/' + this._font.id + ' ' + Cu(this._fontSize) + ' Tf');
  ...
  Du = (function() {
    function e(e, t) {
      ...
      for (
        ...
        (n += 2),
        !Array.from(Fu).includes(r));

      )
        n += this.data.readUInt16BE(n);
      if (!Array.from(Fu).includes(r)) throw 'Invalid JPEG.';
      (n += 2),
    ...
    return (
      (t.embed = function(e) {
        ...
        if (((this.document = e), !this.obj)) {
          ...
          if (0 === this.image.palette.length)
            ...
            o.end(E.from(this.image.palette)),
      ...
      (t.splitAlphaChannel = function() {
        ...
        return this.image.decodePixels(function(t) {
          ...
          return (
            (e.imgData = ei.deflateSync(a)),
            (e.alphaChannel = ei.deflateSync(c)),
            e.finalize()
          );
        });
      }),
      (t.loadIndexedAlphaChannel = function() {
        ...
        return this.image.decodePixels(function(r) {
          for (
            var n = E.alloc(e.width * e.height), i = 0, o = 0, a = r.length;
            o < a;
            o++
          )
            n[i++] = t[r[o]];
          return (e.alphaChannel = ei.deflateSync(n)), e.finalize();
        });
      }),
      (t.decodeData = function() {
        var e = this;
        this.image.decodePixels(function(t) {
          (e.imgData = ei.deflateSync(t)), e.finalize();
        });
      }),
      e
    );
  ...
  Lu = (function() {
    ...
    return (
      (e.open = function(e, t) {
        var r;
        if (E.isBuffer(e)) r = e;
        else if (e instanceof ArrayBuffer) r = E.from(new Uint8Array(e));
        else {
          var n = /^data:.+;base64,(.*)$/.exec(e);
          n && (r = E.from(n[1], 'base64'));
        }
        if (255 === r[0] && 216 === r[1]) return new Du(r, t);
  ...
  ju = {
    ...
    image: function(e, t, r, n) {
      ...
      var l = e instanceof Lu ? e : this.embedImage(e);
    ...
    openImage: function(e) {
      ...
      return (
        'string' == typeof e && (t = this._imageRegistry[e]),
        t ||
          ((t = Lu.open(e, 'I' + ++this._imageCount)),
  ...
  Mu = { top: 0, left: 0, zoom: 0, fit: !1, pageNumber: null, expanded: !1 },
  Bu = (function() {
  ...
  Yu = {
    initOutline: function() {
      this.outline = new Bu(this, null, null, null);
    },
    endOutline: function() {
  ...
  qu = { left: 0, center: 1, right: 2 },
  zu = { value: 'V', defaultValue: 'DV' },
  Vu = { zip: '0', zipPlus4: '1', zip4: '1', phone: '2', ssn: '3' },
  Gu = {
    nDec: 0,
    sepComma: !1,
    negStyle: 'MinusBlack',
  ...
  Hu = {
    ...
    _resolveJustify: function(e) {
      ...
      return (
        void 0 !== e.align &&
          ('number' == typeof qu[e.align] && (t = qu[e.align]), delete e.align),
        0 !== t && (e.Q = t),
        e
      );
    },
    ...
    _resolveStrings: function(e) {
      ...
      return (
        ...
        Object.keys(zu).forEach(function(t) {
          void 0 !== e[t] && ((e[zu[t]] = e[t]), delete e[t]);
        }),
  ...
  Zu = {
    file: function(e, t) {
      ...
      (function(e, t) {
        ...
        ? (o = s.ref)
        : ((o = this.ref(n)).end(r),
          (this._fileRegistry[t.name] = l({}, n, { ref: o })));
      var u = {
        Type: 'Filespec',
        F: new String(t.name),
        EF: { F: o },
      ...
      t.description && (u.Desc = new String(t.description));
      var f = this.ref(u);
  ...
  Xu = (function(t) {
    function r(e) {
      ...
      var n = r.ref({ Type: 'Pages', Count: 0, Kids: [] }),
        i = r.ref({ Dests: new Is() });
      if (
        ((r._root = r.ref({ Type: 'Catalog', Pages: n, Names: i })),
        r.options.lang && (r._root.data.Lang = new String(r.options.lang)),
        r.options.pageLayout &&
          (r._root.data.PageLayout = Ju(r.options.pageLayout)),
        r.options.pageMode && (r._root.data.PageMode = Ju(r.options.pageMode)),
        (r.page = null),
        r.initColor(),
        r.initVector(),
        r.initFonts(),
      ...
      return (
        ...
        (r._id = Xs.generateFileID(r.info)),
...
$u(au), $u(Au), $u(Uu), $u(Pu), $u(ju), $u(Nu), $u(Yu), $u(Hu), $u(Zu);
export { Ru as EmbeddedFont, xu as PDFFont, ku as StandardFont, Xu as default };
