...
var e = require('@babel/runtime/helpers/inheritsLoose'),
  ...
  i = require('crypto-js/md5'),
  n = require('fontkit'),
  o = require('fs'),
  s = require('@react-pdf/png-js'),
    ...
    function a(a, t, r) {
      ...
      return (
        ((c =
          ...
          this).finalize = c.finalize.bind(g.default(c))),
        (c.document = a),
        (c.id = t),
        null == r && (r = {}),
        (c.data = r),
    ...
    return (
      (t.initDeflate = function() {
        ...
        return (
          ...
          (this.deflate = f.default.createDeflate()),
      ...
      (t.finalize = function() {
        if (
          ...
          this.document._write(S.convert(this.data)),
          this.chunks.length)
        ) {
      ...
      return (
        ...
        (a.toString = function() {
          ...
          if (this.limits && a.length > 1) {
            ...
            t.push(
              '  /Limits ' +
                S.convert([this._dataForKey(r), this._dataForKey(c)])
            );
          }
          t.push('  /' + this._keysName() + ' [');
          for (var i, n = A.default(a); !(i = n()).done; ) {
            var o = i.value;
            t.push(
              '    ' +
                S.convert(this._dataForKey(o)) +
                ' ' +
                S.convert(this._items[o])
            );
          }
...
var w,
  ...
  D,
  P,
  W = { top: 0, left: 0, bottom: 0, right: 0 },
  B = {
    '4A0': [4767.87, 6740.79],
    '2A0': [3370.39, 4767.87],
    A0: [2383.94, 3370.39],
  ...
  q = (function() {
    function e(e, a) {
      void 0 === a && (a = {}),
        ...
        (this.margins = W);
      var t = Array.isArray(this.size) ? this.size : B[this.size.toUpperCase()];
      ...
      (a.embed = function(e) {
        ...
        if (0 !== t) {
          ...
          if (
            ...
            for (var l, d = A.default(this.stops); !(l = d()).done; ) {
              var h = l.value;
              m.stop(h[0], [h[2]]);
            }
            ...
            f.write('/Pattern cs /Sh1 scn'), f.end(g.join(' ') + ' re f');
            var v = this.doc.ref({
              Type: 'ExtGState',
              SMask: { Type: 'Mask', S: 'Luminosity', G: f }
            });
            v.end();
            var p = this.doc.ref({
              Type: 'Pattern',
  ...
  E = { PDFGradient: M, PDFLinearGradient: N, PDFRadialGradient: I },
  K = E.PDFGradient,
  L = E.PDFLinearGradient,
  G = E.PDFRadialGradient,
  H = {
    initColor: function() {
      return (
    ...
    _setColor: function(e, a) {
      ...
      var t = a ? 'SCN' : 'scn';
      if (e instanceof K) this._setColorSpace('Pattern', a), e.apply(t);
      else {
    ...
    linearGradient: function(e, a, t, r) {
      return new L(this, e, a, t, r);
    },
    radialGradient: function(e, a, t, r, c, i) {
      return new G(this, e, a, t, r, c, i);
    }
  },
  j = {
...
var J = {
  ...
  ee = {
    M: function(e, a) {
      return (
        (w = a[0]), (_ = a[1]), (F = R = null), (D = w), (P = _), e.moveTo(w, _)
      );
    },
    m: function(e, a) {
      return (
    ...
    S: function(e, a) {
      return (
        null === F && ((F = w), (R = _)),
        e.bezierCurveTo(w - (F - w), _ - (R - _), a[0], a[1], a[2], a[3]),
        (F = a[0]),
        (R = a[1]),
        (w = a[2]),
        (_ = a[3])
    ...
    Q: function(e, a) {
      return (
        ...
        (w = a[2]),
        (_ = a[3]),
        e.quadraticCurveTo(a[0], a[1], w, _)
      );
    },
    q: function(e, a) {
      return (
        e.quadraticCurveTo(a[0] + w, a[1] + _, a[2] + w, a[3] + _),
        (F = w + a[0]),
        (R = _ + a[1]),
        (w += a[2]),
        (_ += a[3])
    ...
    T: function(e, a) {
      return (
        null === F
          ? ((F = w), (R = _))
          : ((F = w - (F - w)), (R = _ - (R - _))),
        e.quadraticCurveTo(F, R, a[0], a[1]),
        (F = w - (F - w)),
        (R = _ - (R - _)),
        (w = a[0]),
        (_ = a[1])
    ...
    t: function(e, a) {
      return (
        null === F
          ? ((F = w), (R = _))
          : ((F = w - (F - w)), (R = _ - (R - _))),
        e.quadraticCurveTo(F, R, w + a[0], _ + a[1]),
        (w += a[0]),
        (_ += a[1])
      );
    },
    A: function(e, a) {
      return ae(e, w, _, a), (w = a[5]), (_ = a[6]);
    },
    a: function(e, a) {
      return (a[5] += w), (a[6] += _), ae(e, w, _, a), (w = a[5]), (_ = a[6]);
    },
    L: function(e, a) {
      return (w = a[0]), (_ = a[1]), (F = R = null), e.lineTo(w, _);
    },
    l: function(e, a) {
      return (w += a[0]), (_ += a[1]), (F = R = null), e.lineTo(w, _);
    },
    H: function(e, a) {
      return (w = a[0]), (F = R = null), e.lineTo(w, _);
    },
    h: function(e, a) {
      return (w += a[0]), (F = R = null), e.lineTo(w, _);
    },
    V: function(e, a) {
      return (_ = a[0]), (F = R = null), e.lineTo(w, _);
    },
    v: function(e, a) {
      return (_ += a[0]), (F = R = null), e.lineTo(w, _);
    },
    Z: function(e) {
      return e.closePath(), (w = D), (_ = P);
    },
    z: function(e) {
      return e.closePath(), (w = D), (_ = P);
    }
  ...
  ae = function(e, a, t, r) {
    for (
      ...
      var g = c.value,
        f = re.apply(void 0, g);
      e.bezierCurveTo.apply(e, f);
    }
  },
  te = function(e, a, t, r, c, i, n, o, s) {
    var u = n * (Math.PI / 180),
      m = Math.sin(u),
      l = Math.cos(u);
    (t = Math.abs(t)), (r = Math.abs(r));
    var d =
      ((F = l * (o - e) * 0.5 + m * (s - a) * 0.5) * F) / (t * t) +
      ((R = l * (s - a) * 0.5 - m * (o - e) * 0.5) * R) / (r * r);
    ...
    var h = l / t,
      ...
      y = h * e + g * a,
      b = f * e + A * a,
      x = 1 / ((y - v) * (y - v) + (b - p) * (b - p)) - 0.25;
    x < 0 && (x = 0);
    var O = Math.sqrt(x);
    i === c && (O = -O);
    var T = 0.5 * (v + y) - O * (b - p),
      k = 0.5 * (p + b) + O * (y - v),
      C = Math.atan2(p - k, v - T),
      U = Math.atan2(b - k, y - T) - C;
    U < 0 && 1 === i
      ? (U += 2 * Math.PI)
      : U > 0 && 0 === i && (U -= 2 * Math.PI);
    for (
      var S = Math.ceil(Math.abs(U / (0.5 * Math.PI + 0.001))), Y = [], w = 0;
      w < S;
      w++
    ) {
      var _ = C + (w * U) / S,
          ...
          for (
            ...
            if (!Q(s))
              if (i && ',' === s) {
                ...
                (r = []),
                  (i = !1),
                  0 === (c = J[(t = s)]) && a.push({ command: t, args: r });
              } else {
                if (null == t) return a;
                var u = o,
                  m = null;
  ...
  oe = {
      ...
      if (Array.isArray(e))
        return (
          (e = Array.from(e)
            ...
            .join(' ')),
          (t = a.phase || 0),
          this.addContent('[' + e + '] ' + S.number(t) + ' d')
        );
      var r = null != a.space ? a.space : e;
      return (
        (t = a.phase || 0),
        this.addContent(
          '[' + S.number(e) + ' ' + S.number(r) + '] ' + S.number(t) + ' d'
        )
      );
    },
    undash: function() {
    ...
    moveTo: function(e, a) {
      return this.addContent(ie(e) + ' ' + ie(a) + ' m');
    },
    lineTo: function(e, a) {
      return this.addContent(ie(e) + ' ' + ie(a) + ' l');
    },
    ...
    quadraticCurveTo: function(e, a, t, r) {
      return this.addContent(
        ie(e) + ' ' + ie(a) + ' ' + ie(t) + ' ' + ie(r) + ' v'
      );
    },
    rect: function(e, a, t, r) {
      return this.addContent(
        ie(e) + ' ' + ie(a) + ' ' + ie(t) + ' ' + ie(r) + ' re'
      );
    },
    roundedRect: function(e, a, t, r, c) {
      null == c && (c = 0);
      var i = (c = Math.min(c, 0.5 * t, 0.5 * r)) * (1 - ne);
      return (
        this.moveTo(e + c, a),
        this.lineTo(e + t - c, a),
...
var me = (function() {
    ...
    (e.open = function(a) {
      return new e(y.default.readFileSync(a, 'utf8'));
    }),
  ...
  ge = (function() {
    ...
    e.open = function(e, a, t, r) {
      var c;
      if ('string' == typeof a) {
        if (fe.isStandardFont(a)) return new fe(e, a, r);
        c = p.openSync(a, t);
      } else
        a instanceof Uint8Array
          ? (c = p.create(a, t))
          : a instanceof ArrayBuffer
          ? (c = p.create(new Uint8Array(a), t))
          : 'object' == typeof a && (c = a);
      if (null == c)
  ...
  ye = {
    ...
    _glyphs: function(e, a, t, r, c) {
      ...
      this.save(),
        ...
        this.addContent('BT'),
        this.addContent('1 0 0 1 ' + pe(t) + ' ' + pe(r) + ' Tm'),
        this.addContent('/' + this._font.id + ' ' + pe(this._fontSize) + ' Tf');
  ...
  xe = (function() {
    function e(e, a) {
      ...
      for (
        ...
        (r += 2),
        !Array.from(be).includes(t));

      )
        r += this.data.readUInt16BE(r);
      if (!Array.from(be).includes(t)) throw 'Invalid JPEG.';
      (r += 2),
    ...
    return (
      (a.embed = function(e) {
        ...
        if (((this.document = e), !this.obj)) {
          ...
          if (0 === this.image.palette.length)
            ...
            i.end(Buffer.from(this.image.palette)),
          ...
          if (null != this.image.transparency.grayscale) {
            ...
            for (
              var o, s = this.image.transparency.rgb, u = [], m = A.default(s);
              !(o = m()).done;
      ...
      (a.splitAlphaChannel = function() {
        ...
        return this.image.decodePixels(function(a) {
          ...
          return (
            (e.imgData = f.default.deflateSync(n)),
            (e.alphaChannel = f.default.deflateSync(o)),
            e.finalize()
          );
        });
      }),
      (a.loadIndexedAlphaChannel = function() {
        ...
        return this.image.decodePixels(function(t) {
          for (
            var r = Buffer.alloc(e.width * e.height),
              c = 0,
              i = 0,
              n = t.length;
            i < n;
            ...
            r[c++] = a[t[i]];
          return (e.alphaChannel = f.default.deflateSync(r)), e.finalize();
        });
      }),
      (a.decodeData = function() {
        var e = this;
        this.image.decodePixels(function(a) {
          (e.imgData = f.default.deflateSync(a)), e.finalize();
        });
      }),
      e
    );
    ...
    return (
      (e.open = function(e, a) {
        ...
        if (Buffer.isBuffer(e)) t = e;
          ...
          else if (!(t = y.default.readFileSync(e))) return;
        }
        if (255 === t[0] && 216 === t[1]) return new xe(t, a);
  ...
  ke = {
    ...
    image: function(e, a, t, r) {
      ...
      var m = e instanceof Te ? e : this.embedImage(e);
    ...
    openImage: function(e) {
      ...
      return (
        'string' == typeof e && (a = this._imageRegistry[e]),
        a ||
          ((a = Te.open(e, 'I' + ++this._imageCount)),
  ...
  Ue = { top: 0, left: 0, zoom: 0, fit: !1, pageNumber: null, expanded: !1 },
  Se = (function() {
  ...
  Ye = {
    initOutline: function() {
      this.outline = new Se(this, null, null, null);
    },
    endOutline: function() {
  ...
  _e = { left: 0, center: 1, right: 2 },
  Fe = { value: 'V', defaultValue: 'DV' },
  Re = { zip: '0', zipPlus4: '1', zip4: '1', phone: '2', ssn: '3' },
  De = {
    nDec: 0,
    sepComma: !1,
    negStyle: 'MinusBlack',
  ...
  We = {
    ...
    _resolveJustify: function(e) {
      ...
      return (
        void 0 !== e.align &&
          ('number' == typeof _e[e.align] && (a = _e[e.align]), delete e.align),
        0 !== a && (e.Q = a),
        e
      );
    },
    ...
    _resolveStrings: function(e) {
      ...
      return (
        ...
        a.length && (e.Opt = a),
        Object.keys(Fe).forEach(function(a) {
          void 0 !== e[a] && ((e[Fe[a]] = e[a]), delete e[a]);
        }),
    ...
    file: function(e, a) {
      ...
      if (Buffer.isBuffer(e)) t = e;
        ...
        if ((c = /^data:(.*);base64,(.*)$/.exec(e)))
          ...
          if (!(t = y.default.readFileSync(e)))
            throw new Error('Could not read contents of file at filepath ' + e);
          var i = y.default.statSync(e),
            n = i.birthtime,
            o = i.ctime;
          (r.Params.CreationDate = n), (r.Params.ModDate = o);
        }
      }
      ...
      var s,
        u = v.default.MD5(v.default.lib.WordArray.create(new Uint8Array(t)));
      (r.Params.CheckSum = new String(u)),
        (r.Params.Size = t.byteLength),
        this._fileRegistry || (this._fileRegistry = {});
      var m = this._fileRegistry[a.name];
      m &&
      (function(e, a) {
        if (
          e.Subtype !== a.Subtype ||
        ...
        ? (s = m.ref)
        : ((s = this.ref(r)).end(t),
          (this._fileRegistry[a.name] = x.default({}, r, { ref: s })));
      var l = {
        Type: 'Filespec',
        F: new String(a.name),
        EF: { F: s },
      ...
      a.description && (l.Desc = new String(a.description));
      var d = this.ref(l);
      return d.end(), a.hidden || this.addNamedEmbeddedFile(a.name, d), d;
    }
  };
var qe = function(e) {
    ...
    function a(a) {
      ...
      if (
        ...
        t.options.pageLayout &&
          (t._root.data.PageLayout = qe(t.options.pageLayout)),
        t.options.pageMode && (t._root.data.PageMode = qe(t.options.pageMode)),
        (t.page = null),
        t.initColor(),
        t.initVector(),
        t.initFonts(),
    ...
    return (
      ...
      (t.addNamedEmbeddedFile = function(e, a) {
        this._root.data.Names.data.EmbeddedFiles ||
          (this._root.data.Names.data.EmbeddedFiles = new T({ limits: !1 })),
...
ze(H),
  ...
  ze(We),
  ze(Be),
  (exports.EmbeddedFont = Ae),
  (exports.PDFFont = ge),
  (exports.StandardFont = fe),
  (exports.default = Ve);
