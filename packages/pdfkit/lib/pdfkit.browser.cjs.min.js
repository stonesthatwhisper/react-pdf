...
var e = require('@babel/runtime/helpers/inheritsLoose'),
  ...
  c = require('crypto-js/md5'),
  s = require('fontkit'),
  u = require('@react-pdf/png-js'),
  l = require('@babel/runtime/helpers/extends');
function f(e) {
...
var d = f(e),
  ...
  E = [],
  T = [],
  x = 'undefined' != typeof Uint8Array ? Uint8Array : Array,
  k = !1;
function R() {
  k = !0;
  for (
...
function P(e) {
  ...
  for (
    ...
    o.push(U(e, c, c + a > s ? s : c + a));
  return (
    1 === n
      ? ((t = e[r - 1]), (i += E[t >> 2]), (i += E[(t << 4) & 63]), (i += '=='))
      : 2 === n &&
        ((t = (e[r - 2] << 8) + e[r - 1]),
        (i += E[t >> 10]),
        (i += E[(t >> 4) & 63]),
...
function j(e, t) {
  ...
  return (
    N.TYPED_ARRAY_SUPPORT
      ? ((e = new Uint8Array(t)).__proto__ = N.prototype)
...
function M(e, t, r, n) {
  ...
  return 'undefined' != typeof ArrayBuffer && t instanceof ArrayBuffer
    ...
    : (function(e, t) {
        if (z(t)) {
          var r = 0 | q(t.length);
          return 0 === (e = j(e, r)).length || t.copy(e, 0, 0, r), e;
        }
        if (t) {
          if (
            ...
            return 'number' != typeof t.length || (n = t.length) != n
              ? j(e, 0)
              : W(e, t);
          if ('Buffer' === t.type && I(t.data)) return W(e, t.data);
        }
        var n;
        throw new TypeError(
...
function Y(e, t) {
  if ((B(t), (e = j(e, t < 0 ? 0 : 0 | q(t))), !N.TYPED_ARRAY_SUPPORT))
    for (var r = 0; r < t; ++r) e[r] = 0;
  return e;
}
function W(e, t) {
  var r = t.length < 0 ? 0 : 0 | q(t.length);
  e = j(e, r);
...
function H(e, t, r, n, i) {
  ...
  if (('string' == typeof t && (t = N.from(t, n)), z(t)))
...
function X(e, t, r, n) {
  return be(ye(t, e.length - r), e, r, n);
}
function $(e, t, r, n) {
  return be(
    (function(e) {
...
(N.TYPED_ARRAY_SUPPORT =
  void 0 === S.TYPED_ARRAY_SUPPORT || S.TYPED_ARRAY_SUPPORT),
  (N.poolSize = 8192),
  ...
  (N.prototype.compare = function(e, t, r, n, i) {
    if (!z(e)) throw new TypeError('Argument must be a Buffer');
    if (
      (void 0 === t && (t = 0),
...
function ue(e, t, r, n, i, o) {
  if (!z(e)) throw new TypeError('"buffer" argument must be a Buffer instance');
...
function de(e, t, r, n, i) {
  return i || he(e, 0, r, 4), F(e, t, r, n, 23, 4), r + 4;
}
function me(e, t, r, n, i) {
  return i || he(e, 0, r, 8), F(e, t, r, n, 52, 8), r + 8;
}
(N.prototype.slice = function(e, t) {
  ...
  if (
    ...
    (r = this.subarray(e, t)).__proto__ = N.prototype;
  else {
    var i = t - e;
    r = new N(i, void 0);
  ...
  (N.prototype.readFloatLE = function(e, t) {
    return t || se(e, 4, this.length), C(this, e, !0, 23, 4);
  }),
  (N.prototype.readFloatBE = function(e, t) {
    return t || se(e, 4, this.length), C(this, e, !1, 23, 4);
  }),
  (N.prototype.readDoubleLE = function(e, t) {
    return t || se(e, 8, this.length), C(this, e, !0, 52, 8);
  }),
  (N.prototype.readDoubleBE = function(e, t) {
    return t || se(e, 8, this.length), C(this, e, !1, 52, 8);
  }),
  (N.prototype.writeUIntLE = function(e, t, r, n) {
    ((e = +e), (t |= 0), (r |= 0), n) ||
      ue(this, e, t, r, Math.pow(2, 8 * r) - 1, 0);
    var i = 1,
      o = 0;
  ...
  (N.prototype.writeInt32LE = function(e, t, r) {
    return (
      (e = +e),
      (t |= 0),
      r || ue(this, e, t, 4, 2147483647, -2147483648),
      N.TYPED_ARRAY_SUPPORT
        ? ((this[t] = 255 & e),
          (this[t + 1] = e >>> 8),
          (this[t + 2] = e >>> 16),
  ...
  (N.prototype.writeDoubleLE = function(e, t, r) {
    return me(this, e, t, !0, r);
  }),
  (N.prototype.writeDoubleBE = function(e, t, r) {
    return me(this, e, t, !1, r);
  }),
  (N.prototype.copy = function(e, t, r, n) {
    ...
    else if (o < 1e3 || !N.TYPED_ARRAY_SUPPORT)
      for (i = 0; i < o; ++i) e[i + t] = this[i + r];
    else Uint8Array.prototype.set.call(e, this.subarray(r, r + o), t);
    return o;
  }),
  (N.prototype.fill = function(e, t, r, n) {
    if ('string' == typeof e) {
      if (
        ('string' == typeof t
      ...
      if ('string' == typeof n && !N.isEncoding(n))
    ...
    if (
      ...
      var a = z(e) ? e : ye(new N(e, n).toString()),
        c = a.length;
      for (o = 0; o < r - t; ++o) this[o + t] = a[o % c];
    }
    return this;
  });
var ge = /[^+\/0-9A-Za-z-_]/g;
function pe(e) {
...
function ve(e) {
  return (function(e) {
    ...
    for (t = 0, r = 0; t < n; t += 4, r += 3)
      (i =
        (T[e.charCodeAt(t)] << 18) |
        (T[e.charCodeAt(t + 1)] << 12) |
        (T[e.charCodeAt(t + 2)] << 6) |
        T[e.charCodeAt(t + 3)]),
        (a[s++] = (i >> 16) & 255),
        (a[s++] = (i >> 8) & 255),
        (a[s++] = 255 & i);
    return (
      2 === o
        ? ((i = (T[e.charCodeAt(t)] << 2) | (T[e.charCodeAt(t + 1)] >> 4)),
          (a[s++] = 255 & i))
        : 1 === o &&
          ((i =
            (T[e.charCodeAt(t)] << 10) |
            (T[e.charCodeAt(t + 1)] << 4) |
            (T[e.charCodeAt(t + 2)] >> 2)),
          (a[s++] = (i >> 8) & 255),
          (a[s++] = 255 & i)),
      a
    );
...
var xe = Ee,
  ke = Te;
function Re(e) {
  if (xe === setTimeout) return setTimeout(e, 0);
  if ((xe === Ee || !xe) && setTimeout)
    return (xe = setTimeout), setTimeout(e, 0);
  try {
    return xe(e, 0);
  } catch (t) {
    try {
      return xe.call(null, e, 0);
    } catch (t) {
      return xe.call(this, e, 0);
    }
  }
}
'function' == typeof S.setTimeout && (xe = setTimeout),
  'function' == typeof S.clearTimeout && (ke = clearTimeout);
var Ue,
  Pe = [],
  Ce = !1,
  Fe = -1;
function De() {
  Ce &&
    Ue &&
    ((Ce = !1),
    Ue.length ? (Pe = Ue.concat(Pe)) : (Fe = -1),
    Pe.length && Ie());
}
function Ie() {
  if (!Ce) {
    ...
    for (var t = Pe.length; t; ) {
      for (Ue = Pe, Pe = []; ++Fe < t; ) Ue && Ue[Fe].run();
      (Fe = -1), (t = Pe.length);
    }
    (Ue = null),
      (Ce = !1),
...
var He,
  Ze = {
    nextTick: function(e) {
      ...
      Pe.push(new Le(e, t)), 1 !== Pe.length || Ce || Re(Ie);
    },
    title: 'browser',
    browser: !0,
    env: {},
  ...
  Je = { exports: {} },
  Xe = 'object' == typeof Reflect ? Reflect : null,
  $e =
    Xe && 'function' == typeof Xe.apply
      ? Xe.apply
      : function(e, t, r) {
          return Function.prototype.apply.call(e, t, r);
        };
He =
  Xe && 'function' == typeof Xe.ownKeys
    ? Xe.ownKeys
  ...
  (Je.exports.once = function(e, t) {
    return new Promise(function(r, n) {
      ...
      lt(e, t, o, { once: !0 }),
        'error' !== t &&
          (function(e, t, r) {
            'function' == typeof e.on && lt(e, 'error', t, r);
          })(e, i, { once: !0 });
    });
  }),
  (et.EventEmitter = et),
...
function nt(e) {
  return void 0 === e._maxListeners ? et.defaultMaxListeners : e._maxListeners;
}
function it(e, t, r, n) {
  var i, o, a, c;
  if (
...
Object.defineProperty(et, 'defaultMaxListeners', {
  ...
  (et.prototype.setMaxListeners = function(e) {
    if ('number' != typeof e || e < 0 || Qe(e))
      throw new RangeError(
  ...
  (et.prototype.emit = function(e) {
    ...
    if ('function' == typeof c) $e(c, this, t);
    else {
      var s = c.length,
        u = ut(c, s);
      for (r = 0; r < s; ++r) $e(u[r], this, t);
    }
    return !0;
  }),
  (et.prototype.addListener = function(e, t) {
    return it(this, e, t, !1);
  }),
  (et.prototype.on = et.prototype.addListener),
  (et.prototype.prependListener = function(e, t) {
    return it(this, e, t, !0);
  }),
  (et.prototype.once = function(e, t) {
    return rt(t), this.on(e, at(this, e, t)), this;
  }),
  (et.prototype.prependOnceListener = function(e, t) {
    return rt(t), this.prependListener(e, at(this, e, t)), this;
  }),
  (et.prototype.removeListener = function(e, t) {
    var r, n, i, o, a;
    if ((rt(t), void 0 === (n = this._events))) return this;
  ...
  (et.prototype.rawListeners = function(e) {
    return ct(this, e, !1);
  }),
  (et.listenerCount = function(e, t) {
    return 'function' == typeof e.listenerCount
      ? e.listenerCount(t)
      : st.call(e, t);
  }),
  (et.prototype.listenerCount = st),
  (et.prototype.eventNames = function() {
    return this._eventsCount > 0 ? He(this._events) : [];
  });
for (
  var ft = Je.exports.EventEmitter,
    ht = {},
    dt = {
      ...
      toByteArray: function(e) {
        ...
        for (r = 0; r < s; r += 4)
          (t =
            (gt[e.charCodeAt(r)] << 18) |
            (gt[e.charCodeAt(r + 1)] << 12) |
            (gt[e.charCodeAt(r + 2)] << 6) |
            gt[e.charCodeAt(r + 3)]),
            (a[c++] = (t >> 16) & 255),
            (a[c++] = (t >> 8) & 255),
            (a[c++] = 255 & t);
        2 === o &&
          ((t = (gt[e.charCodeAt(r)] << 2) | (gt[e.charCodeAt(r + 1)] >> 4)),
          (a[c++] = 255 & t));
        1 === o &&
          ((t =
            (gt[e.charCodeAt(r)] << 10) |
            (gt[e.charCodeAt(r + 1)] << 4) |
            (gt[e.charCodeAt(r + 2)] >> 2)),
          (a[c++] = (t >> 8) & 255),
          (a[c++] = 255 & t));
        return a;
      },
      fromByteArray: function(e) {
        for (
          ...
          i.push(wt(e, a, a + o > c ? c : a + o));
        1 === n
          ? ((t = e[r - 1]), i.push(mt[t >> 2] + mt[(t << 4) & 63] + '=='))
          : 2 === n &&
            ((t = (e[r - 2] << 8) + e[r - 1]),
            i.push(mt[t >> 10] + mt[(t >> 4) & 63] + mt[(t << 2) & 63] + '='));
        return i.join('');
      }
    },
    mt = [],
  ...
  (mt[vt] = yt[vt]), (gt[yt.charCodeAt(vt)] = vt);
function At(e) {
  var t = e.length;
  if (t % 4 > 0)
    throw new Error('Invalid string. Length must be a multiple of 4');
...
var Ot = _e(Object.freeze({ __proto__: null, default: {} }));
function St(e, t) {
  var r = Object.keys(e);
...
var xt = ht.Buffer,
  kt = Ot.inspect,
  Rt = (kt && kt.custom) || 'inspect';
function Ut(e, t, r) {
  xt.prototype.copy.call(e, t, r);
}
var Pt = (function() {
  function e() {
    !(function(e, t) {
  ...
  return (
    ...
    (r = [
      ...
      },
      {
        key: 'concat',
        value: function(e) {
          if (0 === this.length) return xt.alloc(0);
          for (var t = xt.allocUnsafe(e >>> 0), r = this.head, n = 0; r; )
            Ut(r.data, t, n), (n += r.data.length), (r = r.next);
          return t;
        }
      },
      {
...
function Nt(e, t, r) {
  ...
  (n.prototype.name = r.name), (n.prototype.code = e), (jt[e] = n);
}
function Mt(e, t) {
  if (Array.isArray(e)) {
    var r = e.length;
...
Nt(
  ...
  Nt('ERR_STREAM_PUSH_AFTER_EOF', 'stream.push() after EOF'),
  Nt('ERR_METHOD_NOT_IMPLEMENTED', function(e) {
    return 'The ' + e + ' method is not implemented';
  }),
  Nt('ERR_STREAM_PREMATURE_CLOSE', 'Premature close'),
  Nt('ERR_STREAM_DESTROYED', function(e) {
    return 'Cannot call ' + e + ' after a stream was destroyed';
  }),
  Nt('ERR_MULTIPLE_CALLBACK', 'Callback called multiple times'),
  Nt('ERR_STREAM_CANNOT_PIPE', 'Cannot pipe, not readable'),
  Nt('ERR_STREAM_WRITE_AFTER_END', 'write after end'),
  Nt(
  ...
  Nt('ERR_STREAM_UNSHIFT_AFTER_END_EVENT', 'stream.unshift() after end event'),
  (Lt.codes = jt);
var Bt = Lt.codes.ERR_INVALID_OPT_VALUE;
var Yt = {
    getHighWaterMark: function(e, t, r, n) {
      ...
      if (null != i) {
        if (!isFinite(i) || Math.floor(i) !== i || i < 0)
          throw new Bt(n ? r : 'highWaterMark', i);
        return Math.floor(i);
      }
...
function Kt(e) {
  ...
  switch (
    ((this.encoding = (function(e) {
      ...
      if ('string' != typeof t && (Vt.isEncoding === Gt || !Gt(e)))
    ...
    case 'utf16le':
      (this.text = Jt), (this.end = Xt), (t = 4);
      break;
    case 'utf8':
      (this.fillLast = Zt), (t = 4);
      break;
    case 'base64':
      (this.text = $t), (this.end = Qt), (t = 3);
      break;
    default:
      return (this.write = er), void (this.end = tr);
  }
  (this.lastNeed = 0),
    (this.lastTotal = 0),
    (this.lastChar = Vt.allocUnsafe(t));
}
function Ht(e) {
  return e <= 127
    ? 0
...
(qt.StringDecoder = Kt),
  ...
  (Kt.prototype.end = function(e) {
    var t = e && e.length ? this.write(e) : '';
    return this.lastNeed ? t + '�' : t;
  }),
  (Kt.prototype.text = function(e, t) {
    var r = (function(e, t, r) {
      ...
      if (--n < r || -2 === i) return 0;
      if ((i = Ht(t[n])) >= 0) return i > 0 && (e.lastNeed = i - 2), i;
      if (--n < r || -2 === i) return 0;
      if ((i = Ht(t[n])) >= 0)
...
var rr = Lt.codes.ERR_STREAM_PREMATURE_CLOSE;
function nr() {}
var ir,
  or = function e(t, r, n) {
    ...
    var i = r.readable || (!1 !== r.readable && t.readable),
      ...
      h = function() {
        var e;
        return i && !u
          ? ((t._readableState && t._readableState.ended) || (e = new rr()),
            n.call(t, e))
          : o && !c
          ? ((t._writableState && t._writableState.ended) || (e = new rr()),
            n.call(t, e))
          : void 0;
      },
      d = function() {
...
var cr = or,
  sr = Symbol('lastResolve'),
  ur = Symbol('lastReject'),
  lr = Symbol('error'),
  fr = Symbol('ended'),
  hr = Symbol('lastPromise'),
  dr = Symbol('handlePromise'),
  mr = Symbol('stream');
function gr(e, t) {
...
function pr(e) {
  ...
  if (null !== t) {
    var r = e[mr].read();
    null !== r &&
      ((e[hr] = null), (e[sr] = null), (e[ur] = null), t(gr(r, !1)));
  }
}
function yr(e) {
  Ze.nextTick(pr, e);
}
var vr = Object.getPrototypeOf(function() {}),
  br = Object.setPrototypeOf(
    ((ir = {
      ...
      next: function() {
        ...
        if (this[fr]) return Promise.resolve(gr(void 0, !0));
        if (this[mr].destroyed)
          return new Promise(function(t, r) {
            Ze.nextTick(function() {
              e[lr] ? r(e[lr]) : t(gr(void 0, !0));
            });
          });
        var r,
          n = this[hr];
        if (n)
          ...
          var i = this[mr].read();
          if (null !== i) return Promise.resolve(gr(i, !1));
          r = new Promise(this[dr]);
        }
        return (this[hr] = r), r;
      }
    }),
    ar(ir, Symbol.asyncIterator, function() {
      return this;
    }),
    ar(ir, 'return', function() {
      var e = this;
      return new Promise(function(t, r) {
        e[mr].destroy(null, function(e) {
          e ? r(e) : t(gr(void 0, !0));
        });
      });
    }),
  ...
  Ar = function(e) {
    var t,
      r = Object.create(
        br,
        (ar((t = {}), mr, { value: e, writable: !0 }),
        ar(t, sr, { value: null, writable: !0 }),
        ar(t, ur, { value: null, writable: !0 }),
        ar(t, lr, { value: null, writable: !0 }),
        ar(t, fr, { value: e._readableState.endEmitted, writable: !0 }),
        ar(t, dr, {
          value: function(e, t) {
            var n = r[mr].read();
            n
              ? ((r[hr] = null), (r[sr] = null), (r[ur] = null), e(gr(n, !1)))
              : ((r[sr] = e), (r[ur] = t));
          },
          writable: !0
        }),
    ...
    return (
      ...
      cr(e, function(e) {
        if (e && 'ERR_STREAM_PREMATURE_CLOSE' !== e.code) {
          ...
          return (
            null !== t &&
              ((r[hr] = null), (r[sr] = null), (r[ur] = null), t(e)),
            void (r[lr] = e)
          );
        }
        var n = r[sr];
        null !== n &&
          ((r[hr] = null), (r[sr] = null), (r[ur] = null), n(gr(void 0, !0))),
          (r[fr] = !0);
      }),
      e.on('readable', yr.bind(null, r)),
      r
    );
  },
  wr = function() {
  ...
  _r = Se;
(_r.Readable = qr), (qr.ReadableState = Wr), Je.exports.EventEmitter;
var Or = function(e, t) {
    return e.listeners(t).length;
  },
  Sr = ft,
  Er = ht.Buffer,
  Tr = we.Uint8Array || function() {};
var xr,
  kr = Ot;
xr = kr && kr.debuglog ? kr.debuglog('stream') : function() {};
var Rr,
  Ur,
  Pr,
  Cr = Pt,
  Fr = It,
  Dr = Yt.getHighWaterMark,
  Ir = Lt.codes,
  Lr = Ir.ERR_INVALID_ARG_TYPE,
  jr = Ir.ERR_STREAM_PUSH_AFTER_EOF,
  Nr = Ir.ERR_METHOD_NOT_IMPLEMENTED,
  Mr = Ir.ERR_STREAM_UNSHIFT_AFTER_END_EVENT;
Wt.exports(qr, Sr);
var Br = Fr.errorOrDestroy,
  Yr = ['error', 'close', 'destroy', 'pause', 'resume'];
function Wr(e, t, r) {
  (e = e || {}),
    'boolean' != typeof r && (r = t instanceof _r.Duplex),
    (this.objectMode = !!e.objectMode),
    r && (this.objectMode = this.objectMode || !!e.readableObjectMode),
    (this.highWaterMark = Dr(this, e, 'readableHighWaterMark', r)),
    (this.buffer = new Cr()),
    (this.length = 0),
    (this.pipes = null),
    (this.pipesCount = 0),
    ...
    (this.encoding = null),
    e.encoding &&
      (Rr || (Rr = qt.StringDecoder),
      (this.decoder = new Rr(e.encoding)),
      (this.encoding = e.encoding));
}
function qr(e) {
  if (!(this instanceof qr)) return new qr(e);
  var t = this instanceof _r.Duplex;
  (this._readableState = new Wr(e, this, t)),
    (this.readable = !0),
    e &&
...
function zr(e, t, r, n, i) {
  xr('readableAddChunk', t);
  var o,
    a = e._readableState;
  if (null === t)
    (a.reading = !1),
      (function(e, t) {
        if ((xr('onEofChunk'), t.ended)) return;
        if (t.decoder) {
          var r = t.decoder.end();
          r &&
            r.length &&
        ...
        (t.ended = !0),
          t.sync
            ? Kr(e)
            : ((t.needReadable = !1),
              t.emittedReadable || ((t.emittedReadable = !0), Hr(e)));
      })(e, a);
  else if (
    (i ||
      (o = (function(e, t) {
        ...
        (n = t),
          Er.isBuffer(n) ||
            ...
            void 0 === t ||
            e.objectMode ||
            (r = new Lr('chunk', ['string', 'Buffer', 'Uint8Array'], t));
        var n;
        return r;
      })(a, t)),
    o)
    ...
    if (
      ...
      a.endEmitted ? Br(e, new Mr()) : Vr(e, a, t, !0);
    else if (a.ended) Br(e, new jr());
    else {
      if (a.destroyed) return !1;
      (a.reading = !1),
        a.decoder && !r
          ? ((t = a.decoder.write(t)),
            a.objectMode || 0 !== t.length ? Vr(e, a, t, !1) : Zr(e, a))
          : Vr(e, a, t, !1);
    }
  else n || ((a.reading = !1), Zr(e, a));
...
Object.defineProperty(qr.prototype, 'destroyed', {
  enumerable: !1,
  get: function() {
  ...
  (qr.prototype.destroy = Fr.destroy),
  (qr.prototype._undestroy = Fr.undestroy),
  (qr.prototype._destroy = function(e, t) {
    t(e);
  }),
  ...
  (qr.prototype.unshift = function(e) {
    return zr(this, e, null, !0, !1);
  }),
  (qr.prototype.isPaused = function() {
    return !1 === this._readableState.flowing;
  }),
  (qr.prototype.setEncoding = function(e) {
    Rr || (Rr = qt.StringDecoder);
    var t = new Rr(e);
...
function Kr(e) {
  ...
  xr('emitReadable', t.needReadable, t.emittedReadable),
    (t.needReadable = !1),
    t.emittedReadable ||
      (xr('emitReadable', t.flowing),
      (t.emittedReadable = !0),
      Ze.nextTick(Hr, e));
}
function Hr(e) {
  var t = e._readableState;
  xr('emitReadable_', t.destroyed, t.length, t.ended),
    t.destroyed ||
      (!t.length && !t.ended) ||
...
function Zr(e, t) {
  t.readingMore || ((t.readingMore = !0), Ze.nextTick(Jr, e, t));
}
function Jr(e, t) {
  for (
    ;
    ...
    var r = t.length;
    if ((xr('maybeReadMore read 0'), e.read(0), r === t.length)) break;
  }
  t.readingMore = !1;
}
function Xr(e) {
...
function $r(e) {
  xr('readable nexttick read 0'), e.read(0);
}
function Qr(e, t) {
  xr('resume', t.reading),
    t.reading || e.read(0),
...
function en(e) {
  var t = e._readableState;
  for (xr('flow', t.flowing); t.flowing && null !== e.read(); );
}
function tn(e, t) {
  return 0 === t.length
    ? null
...
function rn(e) {
  var t = e._readableState;
  xr('endReadable', t.endEmitted),
    t.endEmitted || ((t.ended = !0), Ze.nextTick(nn, t, e));
}
function nn(e, t) {
  if (
    (xr('endReadableNT', e.endEmitted, e.length),
    !e.endEmitted &&
      0 === e.length &&
...
(qr.prototype.read = function(e) {
  xr('read', e), (e = parseInt(e, 10));
  ...
  if (
    ...
    return (
      xr('read: emitReadable', t.length, t.ended),
      0 === t.length && t.ended ? rn(this) : Kr(this),
      null
    );
  if (0 === (e = Gr(e, t)) && t.ended) return 0 === t.length && rn(this), null;
  var n,
    i = t.needReadable;
  return (
    xr('need readable', i),
    (0 === t.length || t.length - e < t.highWaterMark) &&
      xr('length less than watermark', (i = !0)),
    t.ended || t.reading
      ? xr('reading or ended', (i = !1))
      : i &&
        (xr('do read'),
        (t.reading = !0),
        (t.sync = !0),
        ...
        (t.sync = !1),
        t.reading || (e = Gr(r, t))),
    null === (n = e > 0 ? tn(e, t) : null)
      ? ((t.needReadable = t.length <= t.highWaterMark), (e = 0))
      : ((t.length -= e), (t.awaitDrain = 0)),
    0 === t.length &&
      (t.ended || (t.needReadable = !0), r !== e && t.ended && rn(this)),
    null !== n && this.emit('data', n),
    n
  );
}),
  (qr.prototype._read = function(e) {
    Br(this, new Nr('_read()'));
  }),
  (qr.prototype.pipe = function(e, t) {
    ...
    (n.pipesCount += 1), xr('pipe count=%d opts=%j', n.pipesCount, t);
    var i = (!t || !1 !== t.end) && e !== Ze.stdout && e !== Ze.stderr ? a : d;
    function o(t, i) {
      xr('onunpipe'),
        t === r &&
          i &&
    ...
    n.endEmitted ? Ze.nextTick(i) : r.once('end', i), e.on('unpipe', o);
    var c = (function(e) {
      return function() {
        var t = e._readableState;
        xr('pipeOnDrain', t.awaitDrain),
          t.awaitDrain && t.awaitDrain--,
          0 === t.awaitDrain && Or(e, 'data') && ((t.flowing = !0), en(e));
      };
    })(r);
    e.on('drain', c);
    var s = !1;
      ...
      xr('dest.write', i),
        !1 === i &&
          (((1 === n.pipesCount && n.pipes === e) ||
            (n.pipesCount > 1 && -1 !== on(n.pipes, e))) &&
            !s &&
            (xr('false write response, pause', n.awaitDrain), n.awaitDrain++),
          r.pause());
    }
    function l(t) {
      xr('onerror', t),
    ...
    function h() {
      xr('onfinish'), e.removeListener('close', f), d();
    }
    function d() {
      xr('unpipe'), r.unpipe(e);
    }
    return (
      r.on('data', u),
      (function(e, t, r) {
      ...
      e.once('finish', h),
      e.emit('pipe', r),
      n.flowing || (xr('pipe resume'), r.resume()),
      e
    );
  }),
  (qr.prototype.unpipe = function(e) {
    var t = this._readableState,
      r = { hasUnpiped: !1 };
  ...
  (qr.prototype.on = function(e, t) {
    var r = Sr.prototype.on.call(this, e, t),
      n = this._readableState;
    return (
      'data' === e
        ...
        : 'readable' === e &&
          (n.endEmitted ||
            ...
            (n.flowing = !1),
            (n.emittedReadable = !1),
            xr('on readable', n.length, n.reading),
            n.length ? Kr(this) : n.reading || Ze.nextTick($r, this))),
      r
    );
  }),
  (qr.prototype.addListener = qr.prototype.on),
  (qr.prototype.removeListener = function(e, t) {
    var r = Sr.prototype.removeListener.call(this, e, t);
    return 'readable' === e && Ze.nextTick(Xr, this), r;
  }),
  (qr.prototype.removeAllListeners = function(e) {
    var t = Sr.prototype.removeAllListeners.apply(this, arguments);
    return ('readable' !== e && void 0 !== e) || Ze.nextTick(Xr, this), t;
  }),
  (qr.prototype.resume = function() {
    ...
    return (
      e.flowing ||
        ...
        (function(e, t) {
          t.resumeScheduled ||
            ((t.resumeScheduled = !0), Ze.nextTick(Qr, e, t));
        })(this, e)),
      (e.paused = !1),
      this
    );
  ...
  (qr.prototype.pause = function() {
    return (
      xr('call pause flowing=%j', this._readableState.flowing),
      !1 !== this._readableState.flowing &&
        (xr('pause'), (this._readableState.flowing = !1), this.emit('pause')),
      (this._readableState.paused = !0),
      this
    );
  }),
  (qr.prototype.wrap = function(e) {
    var t = this,
      r = this._readableState,
      n = !1;
    for (var i in (e.on('end', function() {
      if ((xr('wrapped end'), r.decoder && !r.ended)) {
        var e = r.decoder.end();
        e && e.length && t.push(e);
      }
      t.push(null);
    ...
    for (var o = 0; o < Yr.length; o++)
      e.on(Yr[o], this.emit.bind(this, Yr[o]));
    return (
      (this._read = function(t) {
        xr('wrapped _read', t), n && ((n = !1), e.resume());
      }),
      this
    );
  }),
  'function' == typeof Symbol &&
    (qr.prototype[Symbol.asyncIterator] = function() {
      return void 0 === Ur && (Ur = Ar), Ur(this);
    }),
  Object.defineProperty(qr.prototype, 'readableHighWaterMark', {
    enumerable: !1,
    get: function() {
      return this._readableState.highWaterMark;
    }
  }),
  Object.defineProperty(qr.prototype, 'readableBuffer', {
    enumerable: !1,
    get: function() {
      return this._readableState && this._readableState.buffer;
    }
  }),
  Object.defineProperty(qr.prototype, 'readableFlowing', {
    enumerable: !1,
    get: function() {
  ...
  (qr._fromList = tn),
  Object.defineProperty(qr.prototype, 'readableLength', {
    enumerable: !1,
    get: function() {
  ...
  'function' == typeof Symbol &&
    (qr.from = function(e, t) {
      return void 0 === Pr && (Pr = wr), Pr(qr, e, t);
    });
var an = function(e, t) {
  if (cn('noDeprecation')) return e;
  var r = !1;
  return function() {
    if (!r) {
      if (cn('throwDeprecation')) throw new Error(t);
      cn('traceDeprecation') ? console.trace(t) : console.warn(t), (r = !0);
    }
...
(sn.Writable = Rn), (Rn.WritableState = kn);
var ln = { deprecate: an },
  fn = ft,
  hn = ht.Buffer,
  dn = we.Uint8Array || function() {};
var mn,
  gn = It,
  pn = Yt.getHighWaterMark,
  yn = Lt.codes,
  vn = yn.ERR_INVALID_ARG_TYPE,
  bn = yn.ERR_METHOD_NOT_IMPLEMENTED,
  An = yn.ERR_MULTIPLE_CALLBACK,
  wn = yn.ERR_STREAM_CANNOT_PIPE,
  _n = yn.ERR_STREAM_DESTROYED,
  On = yn.ERR_STREAM_NULL_VALUES,
  Sn = yn.ERR_STREAM_WRITE_AFTER_END,
  En = yn.ERR_UNKNOWN_ENCODING,
  Tn = gn.errorOrDestroy;
function xn() {}
function kn(e, t, r) {
  (e = e || {}),
    'boolean' != typeof r && (r = t instanceof sn.Duplex),
    (this.objectMode = !!e.objectMode),
    r && (this.objectMode = this.objectMode || !!e.writableObjectMode),
    (this.highWaterMark = pn(this, e, 'writableHighWaterMark', r)),
    (this.finalCalled = !1),
    (this.needDrain = !1),
    (this.ending = !1),
    (this.ended = !1),
    ...
    (this.onwrite = function(e) {
      !(function(e, t) {
        var r = e._writableState,
          n = r.sync,
          i = r.writecb;
        if ('function' != typeof i) throw new An();
        if (
          ((function(e) {
            (e.writing = !1),
              (e.writecb = null),
          ...
          var o = Fn(r) || e.destroyed;
          o || r.corked || r.bufferProcessing || !r.bufferedRequest || Cn(e, r),
            n ? Ze.nextTick(Pn, e, r, o, i) : Pn(e, r, o, i);
        }
      })(t, e);
    }),
    (this.writecb = null),
...
function Rn(e) {
  var t = this instanceof sn.Duplex;
  if (!t && !mn.call(Rn, this)) return new Rn(e);
  (this._writableState = new kn(e, this, t)),
    (this.writable = !0),
    e &&
...
function Cn(e, t) {
  ...
  if (e._writev && r && r.next) {
    ...
    (i.allBuffers = c),
      Un(e, t, !0, t.length, i, '', o.finish),
      t.pendingcb++,
      (t.lastBufferedRequest = null),
      o.next
        ? ((t.corkedRequestsFree = o.next), (o.next = null))
        : (t.corkedRequestsFree = new un(t)),
    ...
    for (; r; ) {
      var s = r.chunk,
        ...
        l = r.callback;
      if (
        (Un(e, t, !1, t.objectMode ? 1 : s.length, s, u, l),
        (r = r.next),
    ...
    ((function(e, t) {
      t.prefinished ||
        ...
        ('function' != typeof e._final || t.destroyed
          ...
          : (t.pendingcb++, (t.finalCalled = !0), Ze.nextTick(Dn, e, t)));
    })(e, t),
...
Wt.exports(Rn, fn),
  ...
  'function' == typeof Function.prototype[Symbol.hasInstance]
    ? ((mn = Function.prototype[Symbol.hasInstance]),
      Object.defineProperty(Rn, Symbol.hasInstance, {
        value: function(e) {
          return (
            !!mn.call(this, e) ||
            (this === Rn && e && e._writableState instanceof kn)
          );
        }
      }))
    : (mn = function(e) {
  ...
  (Rn.prototype.write = function(e, t, r) {
    var n,
      i = this._writableState,
      o = !1,
      a = !i.objectMode && ((n = e), hn.isBuffer(n) || n instanceof dn);
    return (
      a &&
        !hn.isBuffer(e) &&
        (e = (function(e) {
      ...
      'function' != typeof r && (r = xn),
      i.ending
        ? (function(e, t) {
            var r = new Sn();
            Tn(e, r), Ze.nextTick(t, r);
          })(this, r)
        : (a ||
            (function(e, t, r, n) {
              var i;
              return (
                null === r
                  ...
                  : 'string' == typeof r ||
                    t.objectMode ||
                    (i = new vn('chunk', ['string', 'Buffer'], r)),
                !i || (Tn(e, i), Ze.nextTick(n, i), !1)
              );
            })(this, i, e, r)) &&
          (i.pendingcb++,
          (o = (function(e, t, r, n, i, o) {
            ...
            } else Un(e, t, !1, c, n, i, o);
            return s;
          })(this, i, a, e, t, r))),
      o
    );
  }),
  (Rn.prototype.cork = function() {
    this._writableState.corked++;
  }),
  (Rn.prototype.uncork = function() {
  ...
  (Rn.prototype.setDefaultEncoding = function(e) {
    if (
  ...
  Object.defineProperty(Rn.prototype, 'writableBuffer', {
    enumerable: !1,
    get: function() {
      return this._writableState && this._writableState.getBuffer();
    }
  }),
  Object.defineProperty(Rn.prototype, 'writableHighWaterMark', {
    enumerable: !1,
    get: function() {
      return this._writableState.highWaterMark;
    }
  }),
  (Rn.prototype._write = function(e, t, r) {
    r(new bn('_write()'));
  }),
  (Rn.prototype._writev = null),
  (Rn.prototype.end = function(e, t, r) {
    ...
    return (
      ...
      n.ending ||
        (function(e, t, r) {
          (t.ending = !0),
            In(e, t),
            r && (t.finished ? Ze.nextTick(r) : e.once('finish', r));
          (t.ended = !0), (e.writable = !1);
        })(this, n, r),
      this
    );
  }),
  Object.defineProperty(Rn.prototype, 'writableLength', {
    enumerable: !1,
    get: function() {
      return this._writableState.length;
    }
  }),
  Object.defineProperty(Rn.prototype, 'destroyed', {
    enumerable: !1,
    get: function() {
  ...
  (Rn.prototype.destroy = gn.destroy),
  (Rn.prototype._undestroy = gn.undestroy),
...
var Ln =
  ...
  jn = Se;
(jn.Duplex = Yn), Wt.exports(Yn, jn.Readable);
for (var Nn = Ln(jn.Writable.prototype), Mn = 0; Mn < Nn.length; Mn++) {
  var Bn = Nn[Mn];
  Yn.prototype[Bn] || (Yn.prototype[Bn] = jn.Writable.prototype[Bn]);
}
function Yn(e) {
  if (!(this instanceof Yn)) return new Yn(e);
  jn.Readable.call(this, e),
    jn.Writable.call(this, e),
    (this.allowHalfOpen = !0),
    e &&
      (!1 === e.readable && (this.readable = !1),
      !1 === e.writable && (this.writable = !1),
      !1 === e.allowHalfOpen &&
        ((this.allowHalfOpen = !1), this.once('end', Wn)));
}
function Wn() {
  this._writableState.ended || Ze.nextTick(qn, this);
}
function qn(e) {
  e.end();
}
Object.defineProperty(Yn.prototype, 'writableHighWaterMark', {
  enumerable: !1,
  get: function() {
    return this._writableState.highWaterMark;
  }
}),
  Object.defineProperty(Yn.prototype, 'writableBuffer', {
    enumerable: !1,
    get: function() {
      return this._writableState && this._writableState.getBuffer();
    }
  }),
  Object.defineProperty(Yn.prototype, 'writableLength', {
    enumerable: !1,
    get: function() {
      return this._writableState.length;
    }
  }),
  Object.defineProperty(Yn.prototype, 'destroyed', {
    enumerable: !1,
    get: function() {
      return (
...
zn.Transform = Xn;
var Vn = Lt.codes,
  Gn = Vn.ERR_METHOD_NOT_IMPLEMENTED,
  Kn = Vn.ERR_MULTIPLE_CALLBACK,
  Hn = Vn.ERR_TRANSFORM_ALREADY_TRANSFORMING,
  Zn = Vn.ERR_TRANSFORM_WITH_LENGTH_0;
function Jn(e, t) {
  var r = this._transformState;
  r.transforming = !1;
  var n = r.writecb;
  if (null === n) return this.emit('error', new Kn());
...
function Xn(e) {
  ...
  zn.Duplex.call(this, e),
    (this._transformState = {
      afterTransform: Jn.bind(this),
      needTransform: !1,
      transforming: !1,
      writecb: null,
      writechunk: null,
...
function Qn(e, t, r) {
  ...
  if ((null != r && e.push(r), e._writableState.length)) throw new Zn();
  if (e._transformState.transforming) throw new Hn();
  return e.push(null);
}
Wt.exports(Xn, zn.Duplex),
  (Xn.prototype.push = function(e, t) {
    return (
      (this._transformState.needTransform = !1),
      zn.Duplex.prototype.push.call(this, e, t)
    );
  }),
  ...
  (Xn.prototype._destroy = function(e, t) {
    zn.Duplex.prototype._destroy.call(this, e, function(e) {
      t(e);
    });
  });
var ei,
  ti = Se;
function ri(e) {
  if (!(this instanceof ri)) return new ri(e);
  Transform.call(this, e);
}
(ti.PassThrough = ri),
  Wt.exports(ri, ti.Transform),
  (ri.prototype._transform = function(e, t, r) {
    r(null, e);
  });
var ni = Lt.codes,
  ii = ni.ERR_MISSING_ARGS,
  oi = ni.ERR_STREAM_DESTROYED;
function ai(e) {
  if (e) throw e;
}
function ci(e, t, r, n) {
  ...
  e.on('close', function() {
    ...
    void 0 === ei && (ei = or),
    ei(e, { readable: t, writable: r }, function(e) {
      if (e) return n(e);
      (i = !0), n();
    });
  var o = !1;
...
function li(e) {
  return e.length ? ('function' != typeof e[e.length - 1] ? ai : e.pop()) : ai;
}
var fi = function() {
  ...
  if ((Array.isArray(t[0]) && (t = t[0]), t.length < 2))
    throw new ii('streams');
  var o = t.map(function(e, r) {
    var a = r < t.length - 1;
    return ci(e, a, r > 0, function(e) {
      n || (n = e), e && o.forEach(si), a || (o.forEach(si), i(n));
    });
  });
  return t.reduce(ui);
};
!(function(e, t) {
  var r = Se;
  ((t = Oe.exports = r.Readable).Stream = r.Readable),
...
var hi = Oe.exports,
  ...
  Ai = 'undefined' != typeof Symbol && Symbol,
  wi = bi,
  _i = 'Function.prototype.bind called on incompatible ',
  Oi = Array.prototype.slice,
  Si = Object.prototype.toString,
  Ei = function(e) {
    var t = this;
    if ('function' != typeof t || '[object Function]' !== Si.call(t))
      throw new TypeError(_i + t);
    for (
      var r,
        n = Oi.call(arguments, 1),
        i = function() {
          if (this instanceof r) {
            var i = t.apply(this, n.concat(Oi.call(arguments)));
            return Object(i) === i ? i : this;
          }
          return t.apply(e, n.concat(Oi.call(arguments)));
        },
  ...
  Ti = Function.prototype.bind || Ei,
  xi = Ti.call(Function.call, Object.prototype.hasOwnProperty),
  ki = SyntaxError,
  Ri = Function,
  Ui = TypeError,
  Pi = function(e) {
...
var Fi = function() {
  ...
  ji = {},
  Ni = 'undefined' == typeof Uint8Array ? undefined : Li(Uint8Array),
  Mi = {
    '%AggregateError%':
    ...
    '%ArrayIteratorPrototype%': Ii ? Li([][Symbol.iterator]()) : undefined,
    ...
    '%isFinite%': isFinite,
    '%isNaN%': isNaN,
    '%IteratorPrototype%': Ii ? Li(Li([][Symbol.iterator]())) : undefined,
    '%JSON%': 'object' == typeof JSON ? JSON : undefined,
    '%Map%': 'undefined' == typeof Map ? undefined : Map,
    '%MapIteratorPrototype%':
      'undefined' != typeof Map && Ii
        ? Li(new Map()[Symbol.iterator]())
        : undefined,
    '%Math%': Math,
    '%Number%': Number,
    '%Object%': Object,
    ...
    '%SetIteratorPrototype%':
      'undefined' != typeof Set && Ii
        ? Li(new Set()[Symbol.iterator]())
        : undefined,
    '%SharedArrayBuffer%':
      'undefined' == typeof SharedArrayBuffer ? undefined : SharedArrayBuffer,
    '%String%': String,
    '%StringIteratorPrototype%': Ii ? Li(''[Symbol.iterator]()) : undefined,
    '%Symbol%': Ii ? Symbol : undefined,
    '%SyntaxError%': ki,
    '%ThrowTypeError%': Di,
    '%TypedArray%': Ni,
    '%TypeError%': Ui,
  ...
  Bi = function e(t) {
    var r;
    if ('%AsyncFunction%' === t) r = Pi('async function () {}');
    else if ('%GeneratorFunction%' === t) r = Pi('function* () {}');
    else if ('%AsyncGeneratorFunction%' === t) r = Pi('async function* () {}');
  ...
  Wi = Ti,
  qi = xi,
  zi = Wi.call(Function.call, Array.prototype.concat),
  Vi = Wi.call(Function.apply, Array.prototype.splice),
  Gi = Wi.call(Function.call, String.prototype.replace),
  Ki = Wi.call(Function.call, String.prototype.slice),
  Hi = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
  Zi = /\\(\\)?/g,
  Ji = function(e) {
    var t = Ki(e, 0, 1),
      r = Ki(e, -1);
    if ('%' === t && '%' !== r)
      throw new ki('invalid intrinsic syntax, expected closing `%`');
    if ('%' === r && '%' !== t)
      throw new ki('invalid intrinsic syntax, expected opening `%`');
    var n = [];
    return (
      Gi(e, Hi, function(e, t, r, i) {
        n[n.length] = r ? Gi(i, Zi, '$1') : t || e;
      }),
      n
    );
  },
  Xi = function(e, t) {
    var r,
      n = e;
    if ((qi(Yi, n) && (n = '%' + (r = Yi[n])[0] + '%'), qi(Mi, n))) {
      var i = Mi[n];
      if ((i === ji && (i = Bi(n)), void 0 === i && !t))
        throw new Ui(
          'intrinsic ' +
            e +
  ...
  $i = function(e, t) {
    if ('string' != typeof e || 0 === e.length)
      throw new Ui('intrinsic name must be a non-empty string');
    if (arguments.length > 1 && 'boolean' != typeof t)
      throw new Ui('"allowMissing" argument must be a boolean');
    var r = Ji(e),
      n = r.length > 0 ? r[0] : '',
      i = Xi('%' + n + '%', t),
      o = i.name,
    ...
    for (var u = 1, l = !0; u < r.length; u += 1) {
      ...
      if (
        ...
        throw new ki('property names with quotes must have matching quotes');
      if (
        (('constructor' !== f && l) || (c = !0),
        qi(Mi, (o = '%' + (n += '.' + f) + '%')))
      )
...
var eo = $i,
  to = Qi.exports,
  ro = to(eo('String.prototype.indexOf')),
  no = function(e, t) {
    var r = eo(e, !!t);
    return 'function' == typeof r && ro(e, '.prototype.') > -1 ? to(r) : r;
  },
  io = 'function' == typeof Symbol && 'symbol' == typeof Symbol.toStringTag,
  oo = no('Object.prototype.toString'),
  ao = function(e) {
    return (
      !(io && e && 'object' == typeof e && Symbol.toStringTag in e) &&
      '[object Arguments]' === oo(e)
    );
  },
  co = function(e) {
    return (
      ...
      (null !== e &&
        ...
        e.length >= 0 &&
        '[object Array]' !== oo(e) &&
        '[object Function]' === oo(e.callee))
    );
  },
  so = (function() {
    return ao(arguments);
  })();
ao.isLegacyArguments = co;
var uo,
  lo = so ? ao : co,
  fo = bi,
  ho = function() {
  ...
  bo = function(e) {
    ...
    if (po.test(go.call(e))) return !0;
    if (!yo) return '[object GeneratorFunction]' === mo.call(e);
    if (!vo) return !1;
    if (void 0 === uo) {
      var t = (function() {
        if (!yo) return !1;
  ...
  _o = function(e, t, r) {
    if ('[object Function]' !== wo.call(t))
      throw new TypeError('iterator must be a function');
    var n = e.length;
    if (n === +n) for (var i = 0; i < n; i++) t.call(r, e[i], i, e);
    else for (var o in e) Ao.call(e, o) && t.call(r, e[o], o, e);
  },
  Oo = [
    'BigInt64Array',
    'BigUint64Array',
  ...
  So = 'undefined' == typeof globalThis ? we : globalThis,
  Eo = function() {
    for (var e = [], t = 0; t < Oo.length; t++)
      'function' == typeof So[Oo[t]] && (e[e.length] = Oo[t]);
    return e;
  },
  To = $i('%Object.getOwnPropertyDescriptor%', !0);
if (To)
  try {
    To([], 'length');
  } catch (e) {
...
var xo = To,
  ...
  Ro = Eo,
  Uo = no,
  Po = Uo('Object.prototype.toString'),
  Co = ho(),
  Fo = 'undefined' == typeof globalThis ? we : globalThis,
  Do = Ro(),
  Io =
    Uo('Array.prototype.indexOf', !0) ||
    function(e, t) {
      for (var r = 0; r < e.length; r += 1) if (e[r] === t) return r;
      return -1;
    },
  Lo = Uo('String.prototype.slice'),
  jo = {},
  No = xo,
...
var Bo = function(e) {
  ...
  Wo = Eo,
  qo = no,
  zo = qo('Object.prototype.toString'),
  Vo = ho(),
  Go = 'undefined' == typeof globalThis ? we : globalThis,
  Ko = Wo(),
  Ho = qo('String.prototype.slice'),
  Zo = {},
  Jo = xo,
...
Vo &&
  ...
  Xo &&
  Yo(Ko, function(e) {
    if ('function' == typeof Go[e]) {
      var t = new Go[e]();
      if (Symbol.toStringTag in t) {
        var r = Xo(t),
          n = Jo(r, Symbol.toStringTag);
        if (!n) {
          var i = Xo(r);
          n = Jo(i, Symbol.toStringTag);
        }
        Zo[e] = n.get;
      }
    }
...
!(function(e) {
  ...
  (e.format = function(e) {
    ...
    (e.deprecate = function(t, r) {
      if (void 0 !== Ze && !0 === Ze.noDeprecation) return t;
      if (void 0 === Ze)
        return function() {
  ...
  (e.promisify = function(e) {
    ...
    (e.callbackify = function(e) {
      ...
      function r() {
        ...
        e.apply(this, t).then(
          function(e) {
            Ze.nextTick(o.bind(null, null, e));
          },
          function(e) {
            Ze.nextTick(R.bind(null, e, o));
          }
        );
      }
      return (
...
function ha(e, t) {
  return !t || ('object' !== ba(t) && 'function' != typeof t) ? da(e) : t;
}
function da(e) {
  if (void 0 === e)
    throw new ReferenceError(
...
function ma(e) {
  ...
  return (
    (ma = function(e) {
      ...
      function n() {
        return pa(e, arguments, va(this).constructor);
      }
      return (
...
sa('ERR_AMBIGUOUS_ARGUMENT', 'The "%s" argument is ambiguous. %s', TypeError),
  sa(
    'ERR_INVALID_ARG_TYPE',
    function(e, t, r) {
      var n, i, o, a;
      if (
        (void 0 === oa && (oa = gi.exports),
        oa('string' == typeof e, "'name' must be a string"),
        'string' == typeof t &&
        ((i = 'not '), t.substr(!o || o < 0 ? 0 : +o, i.length) === i)
          ? ((n = 'must not be'), (t = t.replace(/^not /, '')))
          : (n = 'must be'),
  ...
  sa(
    ...
    function() {
      for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++)
        t[r] = arguments[r];
      void 0 === oa && (oa = gi.exports),
        oa(t.length > 0, 'At least one arg needs to be specified');
      var n = 'The ',
        i = t.length;
      switch (
        ((t = t.map(function(e) {
  ...
  (pi.codes = ca);
var Aa = yi.inspect,
  wa = pi.codes.ERR_INVALID_ARG_TYPE;
function _a(e, t, r) {
  return (
    (void 0 === r || r > e.length) && (r = e.length),
    e.substring(r - t.length, r) === t
...
function Ta(e, t, r) {
  ...
  for (f = 0; f < p; f++) {
    ...
    if (u.length < f + 1)
      ...
      var _ = l[f],
        O = u[f],
        S = O !== _ && (!_a(O, ',') || O.slice(0, -1) !== _);
      S && _a(_, ',') && _.slice(0, -1) === O && ((S = !1), (O += ',')),
        S
          ? (w > 1 &&
              f > 2 &&
              (w > 4
...
var xa = (function(e) {
    function t(e) {
      ...
      if (((Error.stackTraceLimit = 0), null != n))
        r = ha(this, va(t).call(this, String(n)));
      else if (
        ('object' === ba(a) &&
          null !== a &&
          'object' === ba(c) &&
        ...
        r = ha(this, va(t).call(this, Ta(a, c, i)));
        ...
        r =
          1 === l.length
            ? ha(this, va(t).call(this, ''.concat(u, ' ').concat(l[0])))
            : ha(
                this,
                va(t).call(
                  this,
        ...
        'notDeepEqual' === i || 'notEqual' === i
          ...
          : ((h = ''.concat(Ea(c))),
            ...
            'deepEqual' === i || 'equal' === i
              ? (f = ''.concat(d, '\n\n').concat(f, '\n\nshould equal\n\n'))
              : (h = ' '.concat(i, ' ').concat(h))),
          (r = ha(this, va(t).call(this, ''.concat(f).concat(h))));
      }
      return (
        (Error.stackTraceLimit = s),
        (r.generatedMessage = !n),
        Object.defineProperty(da(r), 'name', {
        ...
        (r.expected = c),
        (r.operator = i),
        Error.captureStackTrace && Error.captureStackTrace(da(r), o),
        r.stack,
    ...
    return (
      r ||
        (r =
          ...
          'number' == typeof e.length &&
          e.length >= 0 &&
          '[object Function]' === Ca.call(e.callee)),
      r
    );
  };
if (!Object.keys) {
  var Da = Object.prototype.hasOwnProperty,
    ...
    Na = !ja.call({ toString: null }, 'toString'),
    Ma = ja.call(function() {}, 'prototype'),
    Ba = [
      'toString',
      'toLocaleString',
      'valueOf',
  ...
  Ua = function(e) {
    var t = null !== e && 'object' == typeof e,
      r = '[object Function]' === Ia.call(e),
      n = La(e),
      i = t && '[object String]' === Ia.call(e),
      o = [];
    if (!t && !r && !n)
      throw new TypeError('Object.keys called on a non-object');
    var a = Ma && r;
    if (i && e.length > 0 && !Da.call(e, 0))
      for (var c = 0; c < e.length; ++c) o.push(String(c));
    if (n && e.length > 0) for (var s = 0; s < e.length; ++s) o.push(String(s));
    else
      for (var u in e)
        (a && 'prototype' === u) || !Da.call(e, u) || o.push(String(u));
    if (Na)
      for (
        var l = (function(e) {
            if ('undefined' == typeof window || !qa) return Ya(e);
            try {
              return Ya(e);
            } catch (e) {
              return !1;
        ...
        (l && 'constructor' === Ba[f]) || !Da.call(e, Ba[f]) || o.push(Ba[f]);
    return o;
  };
}
var za = Ua,
  ...
  if (Object.keys) {
    ...
    e ||
      (Object.keys = function(e) {
        return Ga(e) ? Za(Va.call(e)) : Za(e);
      });
  } else Object.keys = Ha;
  return Object.keys || Ha;
};
var Ja = Ha,
  Xa = 'function' == typeof Symbol && 'symbol' == typeof Symbol('foo'),
  ...
  tc =
    ...
    (function() {
      var e = {};
      try {
        for (var t in (ec(e, 'x', { enumerable: !1, value: e }), e)) return !1;
        return e.x === e;
      } catch (e) {
        return !1;
      }
  ...
  rc = function(e, t, r, n) {
    ...
    (!(t in e) ||
      ('function' == typeof (i = n) &&
        '[object Function]' === $a.call(i) &&
        n())) &&
      (tc
        ? ec(e, t, { configurable: !0, enumerable: !1, value: r, writable: !0 })
        : (e[t] = r));
  },
  nc = function(e, t) {
    var r = arguments.length > 2 ? arguments[2] : {},
      n = Ja(t);
    Xa && (n = Qa.call(n, Object.getOwnPropertySymbols(t)));
    for (var i = 0; i < n.length; i += 1) rc(e, n[i], t[n[i]], r[n[i]]);
  };
...
var ic = nc,
  ...
  ac = function(e, t) {
    return 0 === e && 0 === t ? 1 / e == 1 / t : e === t || !(!oc(e) || !oc(t));
  },
  cc = ac,
  sc = function() {
    return 'function' == typeof Object.is ? Object.is : cc;
  },
  uc = sc,
  lc = ic,
  fc = ic,
  ...
  gc = (0, Qi.exports)(dc(), Object);
fc(gc, { getPolyfill: dc, implementation: hc, shim: mc });
var pc = gc,
  yc = function(e) {
    return e != e;
  },
  ...
  Tc = (0, Qi.exports)(Sc(), Number);
_c(Tc, { getPolyfill: Sc, implementation: Oc, shim: Ec });
var xc = Tc;
function kc(e, t) {
  return (
    (function(e) {
...
var Uc = void 0 !== /a/g.flags,
  ...
  Fc = Object.is ? Object.is : pc,
  Dc = Object.getOwnPropertySymbols
    ? Object.getOwnPropertySymbols
    : function() {
        return [];
      },
  Ic = Number.isNaN ? Number.isNaN : xc;
function Lc(e) {
  return e.call.bind(e);
}
var jc = Lc(Object.prototype.hasOwnProperty),
  Nc = Lc(Object.prototype.propertyIsEnumerable),
  Mc = Lc(Object.prototype.toString),
  Bc = yi.types,
  Yc = Bc.isAnyArrayBuffer,
  Wc = Bc.isArrayBufferView,
  qc = Bc.isDate,
  zc = Bc.isMap,
  Vc = Bc.isRegExp,
  Gc = Bc.isSet,
  Kc = Bc.isNativeError,
  Hc = Bc.isBoxedPrimitive,
  Zc = Bc.isNumberObject,
  Jc = Bc.isStringObject,
  Xc = Bc.isBooleanObject,
  $c = Bc.isBigIntObject,
  Qc = Bc.isSymbolObject,
  es = Bc.isFloat32Array,
  ts = Bc.isFloat64Array;
function rs(e) {
...
function ns(e) {
  return Object.keys(e)
    .filter(rs)
    .concat(Dc(e).filter(Object.prototype.propertyIsEnumerable.bind(e)));
}
/*!
 * The buffer module from node.js, for the browser.
 *
...
function os(e, t, r, n) {
  if (e === t) return 0 !== e || !r || Fc(e, t);
  if (r) {
    if ('object' !== Rc(e)) return 'number' == typeof e && Ic(e) && Ic(t);
    if ('object' !== Rc(t) || null === e || null === t) return !1;
    if (Object.getPrototypeOf(e) !== Object.getPrototypeOf(t)) return !1;
  } else {
    if (null === e || 'object' !== Rc(e))
      return (null === t || 'object' !== Rc(t)) && e == t;
    if (null === t || 'object' !== Rc(t)) return !1;
  }
  var i,
    o,
    a,
  ...
  if (Array.isArray(e)) {
    ...
    var u = ns(e),
      l = ns(t);
    return u.length === l.length && cs(e, t, r, n, 1, u);
  }
  if ('[object Object]' === s && ((!zc(e) && zc(t)) || (!Gc(e) && Gc(t))))
    return !1;
  if (qc(e)) {
    if (
      !qc(t) ||
    ...
    if (Wc(e)) {
      ...
      var f = ns(e),
        h = ns(t);
      return f.length === h.length && cs(e, t, r, n, 0, f);
    }
    if (Gc(e)) return !(!Gc(t) || e.size !== t.size) && cs(e, t, r, n, 2);
    if (zc(e)) return !(!zc(t) || e.size !== t.size) && cs(e, t, r, n, 3);
    if (Yc(e)) {
      if (
        ((o = t),
        (i = e).byteLength !== o.byteLength ||
          0 !== is(new Uint8Array(i), new Uint8Array(o)))
      )
        return !1;
    } else if (
      Hc(e) &&
    ...
    if (0 !== s.length) {
      ...
      for (c = 0; c < s.length; c++) {
        ...
        if (Nc(e, l)) {
          if (!Nc(t, l)) return !1;
          o.push(l), u++;
        } else if (Nc(t, l)) return !1;
      }
      var f = Dc(t);
      if (s.length !== f.length && as(t, f).length !== u) return !1;
    } else {
      var h = Dc(t);
      if (0 !== h.length && 0 !== as(t, h).length) return !1;
    }
  }
  if (
    0 === o.length &&
...
function hs(e, t, r, n, i, o) {
  for (var a = Pc(e), c = 0; c < a.length; c++) {
    var s = a[c];
    if (os(r, s, i, o) && os(n, t.get(s), i, o)) return e.delete(s), !0;
  }
  return !1;
}
function ds(e, t, r, n, i, o) {
  ...
  if (2 === o) {
    if (
      !(function(e, t, r, n) {
        for (var i = null, o = Pc(e), a = 0; a < o.length; a++) {
          var c = o[a];
          if ('object' === Rc(c) && null !== c)
            null === i && (i = new Set()), i.add(c);
          else if (!t.has(c)) {
            if (r) return !1;
            if (!ls(e, t, c)) return !1;
            null === i && (i = new Set()), i.add(c);
          }
        }
        if (null !== i) {
          for (var s = Pc(t), u = 0; u < s.length; u++) {
            var l = s[u];
            if ('object' === Rc(l) && null !== l) {
              if (!ss(i, l, r, n)) return !1;
            } else if (!r && !e.has(l) && !ss(i, l, r, n)) return !1;
          }
          return 0 === i.size;
        }
        return !0;
    ...
    if (
      !(function(e, t, r, n) {
        for (var i = null, o = Cc(e), a = 0; a < o.length; a++) {
          var c = kc(o[a], 2),
            s = c[0],
            u = c[1];
          if ('object' === Rc(s) && null !== s)
            null === i && (i = new Set()), i.add(s);
          else {
            var l = t.get(s);
            if ((void 0 === l && !t.has(s)) || !os(u, l, r, n)) {
              if (r) return !1;
              if (!fs(e, t, s, u, n)) return !1;
              null === i && (i = new Set()), i.add(s);
            }
          }
        }
        if (null !== i) {
          for (var f = Cc(t), h = 0; h < f.length; h++) {
            var d = kc(f[h], 2),
              m = ((s = d[0]), d[1]);
            if ('object' === Rc(s) && null !== s) {
              if (!hs(i, e, s, m, r, n)) return !1;
            } else if (
              !(
                r ||
                (e.has(s) && os(e.get(s), m, !1, n)) ||
                hs(i, e, s, m, !1, n)
              )
            )
              return !1;
    ...
    for (; a < e.length; a++) {
      if (!jc(e, a)) {
        ...
        for (var c = Object.keys(e); a < c.length; a++) {
          var s = c[a];
          if (!jc(t, s) || !os(e[s], t[s], r, i)) return !1;
        }
        return c.length === Object.keys(t).length;
      }
      if (!jc(t, a) || !os(e[a], t[a], r, i)) return !1;
    }
  for (a = 0; a < n.length; a++) {
    var u = n[a];
    if (!os(e[u], t[u], r, i)) return !1;
  }
  return !0;
}
var ms = {
...
var ps,
  ys,
  vs = pi.codes,
  bs = vs.ERR_AMBIGUOUS_ARGUMENT,
  As = vs.ERR_INVALID_ARG_TYPE,
  ws = vs.ERR_INVALID_ARG_VALUE,
  _s = vs.ERR_INVALID_RETURN_VALUE,
  Os = vs.ERR_MISSING_ARGS,
  Ss = ka,
  Es = yi.inspect,
  Ts = yi.types,
  xs = Ts.isPromise,
  ks = Ts.isRegExp,
  Rs = Object.assign ? Object.assign : Pa.assign,
  Us = Object.is ? Object.is : pc;
function Ps() {
  (ps = ms.isDeepEqual), (ys = ms.isDeepStrictEqual);
}
var Cs = !1,
  Fs = (gi.exports = js),
  Ds = {};
...
function js() {
  for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++)
    t[r] = arguments[r];
  Ls.apply(void 0, [js, t.length].concat(t));
}
(Fs.fail = function e(t, r, n, i, o) {
  var a,
    c = arguments.length;
  if (0 === c) a = 'Failed';
  ...
  (Fs.AssertionError = Ss),
  (Fs.ok = js),
  (Fs.equal = function e(t, r, n) {
    if (arguments.length < 2) throw new Os('actual', 'expected');
    t != r &&
      Is({
        actual: t,
        expected: r,
  ...
  (Fs.notDeepEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new Os('actual', 'expected');
    void 0 === ps && Ps(),
      ps(t, r) &&
        Is({
  ...
  (Fs.deepStrictEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new Os('actual', 'expected');
    void 0 === ps && Ps(),
      ys(t, r) ||
        Is({
  ...
  (Fs.notDeepStrictEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new Os('actual', 'expected');
    void 0 === ps && Ps();
    ys(t, r) &&
      Is({
  ...
  (Fs.strictEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new Os('actual', 'expected');
    Us(t, r) ||
      Is({
        actual: t,
  ...
  (Fs.notStrictEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new Os('actual', 'expected');
    Us(t, r) &&
      Is({
        actual: t,
...
var Ns = function e(t, r, n) {
  ...
  !(function(e, t) {
    ...
    r.forEach(function(e) {
      e in t &&
        (void 0 !== n && 'string' == typeof n[e] && ks(t[e]) && t[e].test(n[e])
          ? (i[e] = n[e])
          : (i[e] = t[e]));
    });
};
function Ms(e, t, r, n, i, o) {
  if (!(r in e) || !ys(e[r], t[r])) {
    if (!n) {
      var a = new Ns(e, i),
        c = new Ns(t, i, e),
        s = new Ss({
...
function Bs(e, t, r, n) {
  if ('function' != typeof t) {
    if (ks(t)) return t.test(e);
    if (2 === arguments.length)
      throw new As('expected', ['Function', 'RegExp'], t);
    ...
    if (t instanceof Error) o.push('name', 'message');
      ...
      throw new ws('error', t, 'may not be an empty object');
    return (
      void 0 === ps && Ps(),
      o.forEach(function(i) {
        ('string' == typeof e[i] && ks(t[i]) && t[i].test(e[i])) ||
          Ms(e, t, i, r, o, n);
      }),
      !0
    );
...
function Ys(e) {
  if ('function' != typeof e) throw new As('fn', 'Function', e);
  try {
    e();
  } catch (e) {
    return e;
...
function qs(e) {
  return Promise.resolve().then(function() {
    var t;
    if ('function' == typeof e) {
      if (!Ws((t = e()))) throw new _s('instance of Promise', 'promiseFn', t);
    } else {
      if (!Ws(e)) throw new As('promiseFn', ['Function', 'Promise'], e);
      t = e;
    }
...
function zs(e, t, r, n) {
  if ('string' == typeof r) {
    if (4 === arguments.length)
      throw new As('error', ['Object', 'Error', 'Function', 'RegExp'], r);
    if ('object' === gs(t) && null !== t) {
      if (t.message === r)
        throw new bs(
          'error/message',
    ...
    (n = r), (r = void 0);
  } else if (null != r && 'object' !== gs(r) && 'function' != typeof r)
    throw new As('error', ['Object', 'Error', 'Function', 'RegExp'], r);
  if (t === Ds) {
    var i = '';
  ...
  if (r && !Bs(t, r, n, e)) throw t;
}
function Vs(e, t, r, n) {
  if (t !== Ds) {
    if (('string' == typeof r && ((n = r), (r = void 0)), !r || Bs(t, r))) {
      var i = n ? ': '.concat(n) : '.',
...
function Gs() {
  for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++)
    t[r] = arguments[r];
  Ls.apply(void 0, [Gs, t.length].concat(t));
}
(Fs.throws = function e(t) {
  for (
    ...
    n[i - 1] = arguments[i];
  zs.apply(void 0, [e, Ys(t)].concat(n));
}),
  (Fs.rejects = function e(t) {
    for (
      var r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), i = 1;
      i < r;
      i++
      ...
      n[i - 1] = arguments[i];
    return qs(t).then(function(t) {
      return zs.apply(void 0, [e, t].concat(n));
    });
  }),
  (Fs.doesNotThrow = function e(t) {
    for (
      var r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), i = 1;
      i < r;
      i++
      ...
      n[i - 1] = arguments[i];
    Vs.apply(void 0, [e, Ys(t)].concat(n));
  }),
  (Fs.doesNotReject = function e(t) {
    for (
      var r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), i = 1;
      i < r;
      i++
  ...
  (Fs.ifError = function e(t) {
    if (null != t) {
      var r = 'ifError got unwanted exception: ';
      'object' === gs(t) && 'string' == typeof t.message
  ...
  (Fs.strict = Rs(Gs, Fs, {
    equal: Fs.strictEqual,
    deepEqual: Fs.deepStrictEqual,
    notEqual: Fs.notStrictEqual,
    notDeepEqual: Fs.notDeepStrictEqual
  })),
  (Fs.strict.strict = Fs.strict),
  (function(e) {
    var t = gi.exports,
      r = g.default,
      n = p.default,
  ...
  (function(e) {
    ...
    function T(e, t) {
      t && Ze.nextTick(t), e._handle && (e._handle.close(), (e._handle = null));
    }
    function x(e) {
      e.emit('close');
    }
...
var Ks = (function(e) {
    function t(t, r, n) {
      ...
      return (
        ((i =
          ...
          this).finalize = i.finalize.bind(m.default(i))),
        (i.document = t),
        (i.id = r),
        null == n && (n = {}),
        (i.data = n),
    ...
    return (
      ...
      (r._write = function(e, t, r) {
        return (
          e instanceof Uint8Array || (e = N.from(e + '\n', 'binary')),
      ...
      (r.finalize = function() {
        if (
          ...
          this.document._write(Qs.convert(this.data)),
          this.chunks.length)
        ) {
      ...
      return (
        ...
        (t.toString = function() {
          ...
          if (this.limits && t.length > 1) {
            ...
            r.push(
              '  /Limits ' +
                Qs.convert([this._dataForKey(n), this._dataForKey(i)])
            );
          }
          r.push('  /' + this._keysName() + ' [');
          for (var o, a = b.default(t); !(o = a()).done; ) {
            var c = o.value;
            r.push(
              '    ' +
                Qs.convert(this._dataForKey(c)) +
                ' ' +
                Qs.convert(this._items[c])
            );
          }
          ...
          return (
            n &&
              (r = (function(e) {
                ...
                return e;
              })(N.from('\ufeff' + r, 'utf16le')).toString('binary')),
            '(' +
              (r = r.replace(Zs, function(e) {
                return Js[e];
              })) +
              ')'
          );
        }
        if (N.isBuffer(t)) return '<' + t.toString('hex') + '>';
        if (t instanceof Ks || t instanceof Hs) return t.toString();
        if (t instanceof Date)
          return (
            '(D:' +
            Xs(t.getUTCFullYear(), 4) +
            Xs(t.getUTCMonth() + 1, 2) +
            Xs(t.getUTCDate(), 2) +
            Xs(t.getUTCHours(), 2) +
            Xs(t.getUTCMinutes(), 2) +
            Xs(t.getUTCSeconds(), 2) +
            'Z)'
          );
        if (Array.isArray(t))
          return (
      ...
      (t.embed = function(e) {
        ...
        if (0 !== r) {
          ...
          if (
            ...
            for (var f, h = b.default(this.stops); !(f = h()).done; ) {
              var d = f.value;
              l.stop(d[0], [d[2]]);
            }
...
var wu = {
  ...
  Tu = {
    ...
    S: function(e, t) {
      return (
        null === nu && ((nu = tu), (iu = ru)),
        e.bezierCurveTo(tu - (nu - tu), ru - (iu - ru), t[0], t[1], t[2], t[3]),
        (nu = t[0]),
        (iu = t[1]),
        (tu = t[2]),
        (ru = t[3])
    ...
    Q: function(e, t) {
      return (
        ...
        (tu = t[2]),
        (ru = t[3]),
        e.quadraticCurveTo(t[0], t[1], tu, ru)
      );
    },
    q: function(e, t) {
      return (
        e.quadraticCurveTo(t[0] + tu, t[1] + ru, t[2] + tu, t[3] + ru),
        (nu = tu + t[0]),
        (iu = ru + t[1]),
        (tu += t[2]),
        (ru += t[3])
    ...
    T: function(e, t) {
      return (
        null === nu
          ? ((nu = tu), (iu = ru))
          : ((nu = tu - (nu - tu)), (iu = ru - (iu - ru))),
        e.quadraticCurveTo(nu, iu, t[0], t[1]),
        (nu = tu - (nu - tu)),
        (iu = ru - (iu - ru)),
        (tu = t[0]),
        (ru = t[1])
    ...
    t: function(e, t) {
      return (
        null === nu
          ? ((nu = tu), (iu = ru))
          : ((nu = tu - (nu - tu)), (iu = ru - (iu - ru))),
        e.quadraticCurveTo(nu, iu, tu + t[0], ru + t[1]),
        (tu += t[0]),
        (ru += t[1])
      );
    },
    A: function(e, t) {
      return xu(e, tu, ru, t), (tu = t[5]), (ru = t[6]);
    },
    a: function(e, t) {
      return (
        (t[5] += tu), (t[6] += ru), xu(e, tu, ru, t), (tu = t[5]), (ru = t[6])
      );
    },
    L: function(e, t) {
      return (tu = t[0]), (ru = t[1]), (nu = iu = null), e.lineTo(tu, ru);
    },
    l: function(e, t) {
      return (tu += t[0]), (ru += t[1]), (nu = iu = null), e.lineTo(tu, ru);
    },
    H: function(e, t) {
      return (tu = t[0]), (nu = iu = null), e.lineTo(tu, ru);
    },
    h: function(e, t) {
      return (tu += t[0]), (nu = iu = null), e.lineTo(tu, ru);
    },
    V: function(e, t) {
      return (ru = t[0]), (nu = iu = null), e.lineTo(tu, ru);
    },
    v: function(e, t) {
      return (ru += t[0]), (nu = iu = null), e.lineTo(tu, ru);
    },
    Z: function(e) {
      return e.closePath(), (tu = ou), (ru = au);
    },
    z: function(e) {
      return e.closePath(), (tu = ou), (ru = au);
    }
  ...
  ku = function(e, t, r, n, i, o, a, c, s) {
    ...
    var h =
      ((nu = f * (c - e) * 0.5 + l * (s - t) * 0.5) * nu) / (r * r) +
      ((iu = f * (s - t) * 0.5 - l * (c - e) * 0.5) * iu) / (n * n);
          ...
          for (
            ...
            if (!Ou(s))
              if (o && ',' === s) {
                ...
                (n = []),
                  (o = !1),
                  0 === (i = wu[(r = s)]) && t.push({ command: r, args: n });
              } else {
                if (null == r) return t;
                var u = c,
                  l = null;
  ...
  Fu = {
      ...
      if (Array.isArray(e))
        return (
          (e = Array.from(e)
            ...
            .join(' ')),
          (r = t.phase || 0),
          this.addContent('[' + e + '] ' + Qs.number(r) + ' d')
        );
      var n = null != t.space ? t.space : e;
      return (
        (r = t.phase || 0),
        this.addContent(
          '[' + Qs.number(e) + ' ' + Qs.number(n) + '] ' + Qs.number(r) + ' d'
        )
      );
    },
    undash: function() {
    ...
    moveTo: function(e, t) {
      return this.addContent(Pu(e) + ' ' + Pu(t) + ' m');
    },
    lineTo: function(e, t) {
      return this.addContent(Pu(e) + ' ' + Pu(t) + ' l');
    },
    ...
    quadraticCurveTo: function(e, t, r, n) {
      return this.addContent(
        Pu(e) + ' ' + Pu(t) + ' ' + Pu(r) + ' ' + Pu(n) + ' v'
      );
    },
    rect: function(e, t, r, n) {
      return this.addContent(
        Pu(e) + ' ' + Pu(t) + ' ' + Pu(r) + ' ' + Pu(n) + ' re'
      );
    },
    roundedRect: function(e, t, r, n, i) {
      null == i && (i = 0);
      var o = (i = Math.min(i, 0.5 * r, 0.5 * n)) * (1 - Cu);
      return (
        this.moveTo(e + i, t),
        this.lineTo(e + r - i, t),
...
var Lu = (function() {
  ...
  Vu = {
    ...
    _glyphs: function(e, t, r, n, i) {
      ...
      this.save(),
        ...
        this.addContent('/' + this._font.id + ' ' + zu(this._fontSize) + ' Tf');
    ...
    return (
      (t.embed = function(e) {
        ...
        if (((this.document = e), !this.obj)) {
          ...
          if (0 === this.image.palette.length)
            ...
            o.end(N.from(this.image.palette)),
          ...
          if (null != this.image.transparency.grayscale) {
            ...
            for (
              var c, s = this.image.transparency.rgb, u = [], l = b.default(s);
              !(c = l()).done;
      ...
      (t.splitAlphaChannel = function() {
        ...
        return this.image.decodePixels(function(t) {
          ...
          return (
            (e.imgData = di.deflateSync(a)),
            (e.alphaChannel = di.deflateSync(c)),
            e.finalize()
          );
        });
      }),
      (t.loadIndexedAlphaChannel = function() {
        ...
        return this.image.decodePixels(function(r) {
          for (
            var n = N.alloc(e.width * e.height), i = 0, o = 0, a = r.length;
            o < a;
            o++
          )
            n[i++] = t[r[o]];
          return (e.alphaChannel = di.deflateSync(n)), e.finalize();
        });
      }),
      (t.decodeData = function() {
        var e = this;
        this.image.decodePixels(function(t) {
          (e.imgData = di.deflateSync(t)), e.finalize();
        });
      }),
      e
    );
  ...
  Zu = (function() {
    ...
    return (
      (e.open = function(e, t) {
        var r;
        if (N.isBuffer(e)) r = e;
        else if (e instanceof ArrayBuffer) r = N.from(new Uint8Array(e));
        else {
          var n = /^data:.+;base64,(.*)$/.exec(e);
          n && (r = N.from(n[1], 'base64'));
        }
        if (255 === r[0] && 216 === r[1]) return new Ku(r, t);
  ...
  Ju = {
    ...
    image: function(e, t, r, n) {
      ...
      var l = e instanceof Zu ? e : this.embedImage(e);
    ...
    openImage: function(e) {
      ...
      return (
        'string' == typeof e && (t = this._imageRegistry[e]),
        t ||
          ((t = Zu.open(e, 'I' + ++this._imageCount)),
  ...
  $u = { top: 0, left: 0, zoom: 0, fit: !1, pageNumber: null, expanded: !1 },
  Qu = (function() {
  ...
  cl = {
    ...
    _resolveJustify: function(e) {
      ...
      return (
        void 0 !== e.align &&
          ('number' == typeof rl[e.align] && (t = rl[e.align]), delete e.align),
        0 !== t && (e.Q = t),
        e
      );
    },
  ...
  sl = {
    file: function(e, t) {
      ...
      var o,
        a = A.default.MD5(A.default.lib.WordArray.create(new Uint8Array(r)));
      (n.Params.CheckSum = new String(a)),
        (n.Params.Size = r.byteLength),
        this._fileRegistry || (this._fileRegistry = {});
      var c = this._fileRegistry[t.name];
      c &&
      (function(e, t) {
        if (
          e.Subtype !== t.Subtype ||
          e.Params.CheckSum.toString() !== t.Params.CheckSum.toString() ||
          e.Params.Size !== t.Params.Size ||
          e.Params.CreationDate !== t.Params.CreationDate ||
          e.Params.ModDate !== t.Params.ModDate
        )
          return !1;
        return !0;
      })(n, c)
        ? (o = c.ref)
        : ((o = this.ref(n)).end(r),
          (this._fileRegistry[t.name] = O.default({}, n, { ref: o })));
      var s = {
        Type: 'Filespec',
        F: new String(t.name),
        EF: { F: o },
      ...
      t.description && (s.Desc = new String(t.description));
      var u = this.ref(s);
      return u.end(), t.hidden || this.addNamedEmbeddedFile(t.name, u), u;
    }
  };
var ul = function(e) {
  ...
  ll = (function(e) {
    function t(t) {
      ...
      if (
        ...
        r.options.pageMode && (r._root.data.PageMode = ul(r.options.pageMode)),
        (r.page = null),
        r.initColor(),
        r.initVector(),
        r.initFonts(),
...
fl(bu),
  ...
  fl(cl),
  fl(sl),
  (exports.EmbeddedFont = Wu),
  (exports.PDFFont = Bu),
  (exports.StandardFont = Yu),
  (exports.default = ll);
